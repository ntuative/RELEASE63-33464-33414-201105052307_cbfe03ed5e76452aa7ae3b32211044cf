package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_2076:int = 0;
      ...
      public static function method_2(param1:int) : Boolean
      {
      ...
      {
         if(this.var_1547 != null && this.var_1547.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_451;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         if(_loc10_ > this.var_451)
         {
            this.var_451 = _loc10_;
         }
         return true;
      }
