package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1994:int = 1;
      
      public static const const_1935:int = 16777216;
      ...
      private var var_2102:int = 16777216;
      
      private var var_2992:int = 69069;
      
      private var var_2993:int = 5;
      ...
      {
         var _loc1_:int = this.var_2992 * this.var_2103 + this.var_2993;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2102;
         this.var_2103 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2102 * param2);
      }
   }
}
