package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1845:int = 16777215;
      
      public static const const_1627:int = 13421772;
      
      private static const const_1034:int = 16777215;
      
      private static const const_1033:int = 13421772;
      
      private static const const_1036:int = 10066329;
      
      private static const const_1035:int = 10066329;
      
      public static const const_1821:int = 16777215;
      
      public static const const_1586:int = 13421772;
      
      public static const const_1601:int = 10066329;
      ...
      private var var_776:Rectangle = null;
      
      private var var_515:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2492:String = null;
      
      private var var_1171:uint = 16777215;
      
      private var var_2491:int = 255;
      
      private var var_2490:int = 255;
      
      private var var_2489:int = 255;
      
      private var var_1800:Boolean = true;
      
      private var var_1648:int = 0;
      
      private var var_1671:int = -1000;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_515 = new RoomPlaneBitmapMaskParser();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_144 != null)
         {
            ...
            {
               _loc4_ = this.var_144[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_776 = super.boundingRectangle;
         }
         return new Rectangle(this.var_776.x,this.var_776.y,this.var_776.width,this.var_776.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_144.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_144[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_131 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1136);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1205);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_188)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_131,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
               ...
               {
                  _loc13_.color = const_1035;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1034;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1033;
               }
               else
               {
                  _loc13_.color = const_1036;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_353)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1821;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1586;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1552)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_131,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_353)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1671 + this.const_2143 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_359.length)
            {
               _loc11_ = this.var_622[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_359[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1800)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2489 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2490 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2491 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1796)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1449 || _loc3_.y != this.var_2484 || _loc3_.z != this.var_2485 || param1.scale != this.var_2486))
            {
               this.var_1449 = _loc3_.x;
               this.var_2484 = _loc3_.y;
               this.var_2485 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1257);
            if(_loc3_ != this.var_2492)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2492 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_813));
            if(_loc4_ != this.var_1171)
            {
               this.var_1171 = _loc4_;
               this.var_2489 = this.var_1171 & 255;
               this.var_2490 = this.var_1171 >> 8 & 255;
               this.var_2491 = this.var_1171 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1143));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_173 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_215);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_207);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_214);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_845));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_982));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_820));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_144[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_230 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_131 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_359;
         if(this.var_359.length == 0)
         {
            _loc6_ = this.var_144;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_359.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_230)
                        {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_359.push(_loc12_);
                        this.var_622.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1648;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_515.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_144.length)
         {
            _loc3_ = this.var_144[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_515.maskCount)
         {
            _loc10_ = this.var_515.getMaskType(_loc8_);
            _loc11_ = this.var_515.getMaskLocation(_loc8_);
            _loc12_ = this.var_515.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_144.length)
               {
                  _loc3_ = this.var_144[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_131 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_131 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_300)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_144[_loc18_] as RoomPlane;
