package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1431:String = "head";
      
      private static const const_667:int = 1;
      
      private static const const_1042:int = 1000;
      
      private static const const_1430:String = "pet_experience_bubble_png";
      
      private static const const_1433:int = 0;
      
      private static const const_1432:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1430) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_364 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_241);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_161);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_241);
            if(!isNaN(_loc6_))
            {
               _loc10_ = this._animationData.getPostureCount(var_89);
               if(_loc10_ > 0)
               {
                  _loc4_ = this._animationData.getPostureForAnimation(var_89,_loc6_ % _loc10_);
                  _loc5_ = null;
               }
            }
            ...
            if(!isNaN(_loc7_))
            {
               _loc11_ = this._animationData.getGestureCount(var_89);
               if(_loc11_ > 0)
               {
                  _loc5_ = this._animationData.getGestureForAnimation(var_89,_loc7_ % _loc11_);
               }
            }
            this.validateActions(_loc4_,_loc5_);
            this.var_2019 = _loc3_.getNumber(RoomObjectVariableEnum.const_407) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_210);
            if(!isNaN(_loc8_))
            {
               this.var_1824 = _loc8_;
            }
            else
            {
               this.var_1824 = direction;
            }
            this.var_1463 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2401 = _loc3_.getNumber(RoomObjectVariableEnum.const_763);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_977);
            if(_loc9_ != this.var_1825)
            {
               this.var_1825 = _loc9_;
               this.var_2533 = this.var_1825.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_364 != null)
         {
            ...
            if(this.var_1463 > 0)
            {
               ...
               if(_loc2_ < const_1042)
               {
                  this.var_364.alpha = int(Math.sin(_loc2_ / const_1042 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_364.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_364.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_278)
         {
            this.var_278 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_89,param1);
            this.setAnimationForIndex(const_1433,_loc3_);
         }
         if(param2 != this.var_1587)
         {
            this.var_1587 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_89,param2);
            this.setAnimationForIndex(const_1432,_loc3_);
         }
      }
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_117.length)
         {
            _loc5_ = this.var_117[_loc4_];
            if(_loc5_ != null)
            {
               if(!_loc5_.animationOver)
               {
                  ...
                  else if(AnimationData.method_2(_loc5_.animationId) || AnimationData.isTransitionToAnimation(_loc5_.animationId))
                  {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2533);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_667)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_592.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_592[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1824);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_89,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1431)
            {
               this.var_965[param1] = true;
            }
            else
            {
               this.var_965[param1] = false;
            }
         }
