package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_155:int = 0;
      ...
      {
         return param1 + param2 * const_1464;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_155,const_80,const_71,const_155,const_80,const_71];
                     _loc8_ = [const_80,const_80,const_80,const_71,const_71,const_71];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
