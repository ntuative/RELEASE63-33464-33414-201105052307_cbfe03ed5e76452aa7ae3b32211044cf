package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_108:AnimationStateData;
      ...
      {
         super();
         this.var_108 = new AnimationStateData();
      }
      ...
      {
         return this.var_108.animationId;
      }
      
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         var _loc2_:int = this.animationId;
         if(_loc2_ != const_1277 && this._animationData.hasAnimation(this.var_484,_loc2_))
         {
            return _loc2_;
         }
         return const_1277;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_904);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_904);
                     if(_loc4_ > this.var_1643)
                     {
                        this.var_1643 = _loc4_;
      ...
      private function isPlayingTransition(param1:AnimationStateData, param2:int) : Boolean
      {
         ...
         if(AnimationData.method_2(_loc3_) || AnimationData.isTransitionToAnimation(_loc3_))
         {
      ...
      private function getCurrentState(param1:AnimationStateData) : int
      {
         ...
         if(AnimationData.method_2(_loc2_) || AnimationData.isTransitionToAnimation(_loc2_))
         {
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_108,param1,this._state >= 0);
         }
      }
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_484,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_484,_loc6_))
                  {
            ...
            else if(AnimationData.method_2(_loc4_))
            {
               _loc6_ = AnimationData.getTransitionToAnimationId(param2);
               if(this._animationData.hasAnimation(this.var_484,_loc6_))
               {
      ...
      {
         return this.var_108.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_108 != null)
         {
            this.var_108.setLayerCount(this.var_687);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(param1 != this.var_484)
         {
            this.var_484 = param1;
            this.var_687 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_108.animationOver || this.var_884)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_108,param1);
            if(this.var_108.animationOver)
            {
               if(AnimationData.method_2(this.var_108.animationId) || AnimationData.isTransitionToAnimation(this.var_108.animationId))
               {
                  this.setAnimation(this.var_108.animationAfterTransitionId);
                  this.var_108.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_884)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_687 - 1;
         var _loc8_:int = this.var_687 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.getAnimationPlayed(_loc8_);
            if(!_loc9_ || this.var_884)
            {
               ...
               if(this.var_884 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1251)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_644)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_108.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_108.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
