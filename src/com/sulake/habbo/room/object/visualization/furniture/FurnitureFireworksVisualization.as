package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_237:FurnitureParticleSystem;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_680)
         {
            for each(_loc1_ in this.var_680)
            {
               _loc1_.dispose();
            }
            this.var_680 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_237 = this.var_680[param1];
               _loc3_ = true;
            }
            else if(param1 != var_89)
            {
               if(this.var_237)
               {
                  this.var_237.reset();
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_237)
         {
            this.var_237.setAnimation(param1);
         }
      ...
      {
         if(this.var_237 && this.var_237.controlsSprite(param3))
         {
            return this.var_237.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1280);
         if(_loc3_.length == 0)
         {
