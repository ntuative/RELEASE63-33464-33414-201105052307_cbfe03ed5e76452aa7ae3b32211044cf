package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_1023:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_763 != _loc2_)
         {
            ...
            if(_loc3_ * const_459 > const_1023)
            {
               this.var_1114 = const_1023 / _loc3_;
            }
            else
            {
               this.var_1114 = const_459;
            }
            this.var_1435 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_763 && param1 >= this.var_1435 + this.var_1114)
            {
               _loc3_ = param1 - this.var_1435;
               ...
               this.var_1435 = param1 - (_loc3_ - _loc4_ * this.var_1114);
            }
         }
      }
   }
