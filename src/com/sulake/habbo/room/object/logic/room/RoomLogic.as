package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1769:int = 255;
      
      private var var_1535:uint = 16777215;
      
      private var var_1925:int = 255;
      
      private var var_1253:uint = 16777215;
      
      private var var_1927:int = 255;
      
      private var var_1252:int = 0;
      
      private var var_1926:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_611,RoomObjectMouseEvent.const_163];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1136,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_813,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_845,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_982,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_820,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1252)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1769;
            if(_loc2_ - this.var_1252 >= this.var_1926)
            {
               _loc3_ = this.var_1253;
               _loc4_ = this.var_1927;
               this.var_1252 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1253 >> 16 & 255;
               _loc11_ = this.var_1253 >> 8 & 255;
               _loc12_ = this.var_1253 & 255;
               _loc13_ = (_loc2_ - this.var_1252) / this.var_1926;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1925 + (this.var_1927 - this.var_1925) * _loc13_;
               this._color = _loc3_;
               this.var_1769 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_813,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_932:
               param2.setString(RoomObjectVariableEnum.const_207,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_958:
               param2.setString(RoomObjectVariableEnum.const_215,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_909:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_518:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_300)
               {
                  _loc5_ = "null";
               }
               this.var_515.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_688:
               _loc4_ = this.var_515.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_515.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1257,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1165:
               param2.setNumber(RoomObjectVariableEnum.const_845,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1133:
               param2.setNumber(RoomObjectVariableEnum.const_982,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_820,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1143,int(param1.bgOnly));
         this.var_1535 = this._color;
         this.var_1925 = this.var_1769;
         this.var_1253 = _loc3_;
         this.var_1927 = _loc4_;
         this.var_1252 = getTimer();
         this.var_1926 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1564,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1809,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1679,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_188 || _loc12_ == RoomPlaneData.const_353)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
