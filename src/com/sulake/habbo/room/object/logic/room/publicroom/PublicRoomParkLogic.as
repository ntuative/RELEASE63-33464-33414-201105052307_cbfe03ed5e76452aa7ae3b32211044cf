package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1516:String = "goawaybus";
      
      private static const const_1518:String = "bus";
      
      private static const const_1517:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_621,RoomObjectRoomActionEvent.const_547];
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1516:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_621,0,_loc4_,_loc5_);
                     break;
                  case const_1518:
                  case const_1517:
