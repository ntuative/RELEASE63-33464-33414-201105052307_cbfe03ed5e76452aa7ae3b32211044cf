   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_158)
            {
               this.var_21.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_2240 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_21.tellUI(HabboHelpViewEnum.const_978);
      }
      ...
      {
         this.var_21.showUI(HabboHelpViewEnum.const_433);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this.var_21.tellUI(HabboHelpViewEnum.const_220);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_21.showUI(HabboHelpViewEnum.const_600);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_21.tellUI(HabboHelpViewEnum.const_349,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_21.tellUI(HabboHelpViewEnum.const_273,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_21.showUI(HabboHelpViewEnum.const_1118);
         this.var_21.tellUI(HabboHelpViewEnum.const_1118,_loc5_);
      }
