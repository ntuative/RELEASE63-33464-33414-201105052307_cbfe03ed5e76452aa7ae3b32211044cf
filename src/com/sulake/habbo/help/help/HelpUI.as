package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105052302));
         this._toolbar = param5;
         this.var_112 = new Map();
         this.var_112.add(HabboHelpViewEnum.const_1623,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_220,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_600,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_349,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_273,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_433,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_927,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_263,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_112.add(HabboHelpViewEnum.const_1113,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_112.add(HabboHelpViewEnum.const_1296,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_112.add(HabboHelpViewEnum.const_978,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_509.length == 0 || param1 != this.var_350)
            {
               this.var_509.push(this.var_350);
            }
         }
         this.var_350 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_263:
               ...
               break;
            case CallForHelpResultEnum.const_1126:
               this.showUI(HabboHelpViewEnum.const_1296);
               break;
            case CallForHelpResultEnum.const_1154:
               this.showUI(HabboHelpViewEnum.const_1113);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_112.getValue(HabboHelpViewEnum.const_220) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_550));
      }
      ...
      {
         return this.var_112.getValue(this.var_350);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2382 = this._window.width - _loc3_.width;
         this.var_2381 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2381;
         this._window.width = _loc1_.width + this.var_2382;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_509.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_350 == HabboHelpViewEnum.const_220)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_351.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_350 == HabboHelpViewEnum.const_220 || this.var_509.length == 0)
         {
            return;
         }
         if(this.var_351 == null)
         {
            ...
            this.var_351 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_351.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_351.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_351 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_351 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_351 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
