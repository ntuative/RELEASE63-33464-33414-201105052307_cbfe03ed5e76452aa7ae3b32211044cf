package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_829:FaqCategory;
      
      private var var_830:FaqCategory;
      ...
      {
         super();
         this.var_829 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_830 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_828 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_829.hasItem(param1))
         {
            this.var_829.getItem(param1).answerText = param2;
         }
         if(this.var_830.hasItem(param1))
         {
            this.var_830.getItem(param1).answerText = param2;
         }
         if(this.var_828.hasItem(param1))
         {
            this.var_828.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_829.hasItem(param1))
         {
            return this.var_829.getItem(param1);
         }
         if(this.var_830.hasItem(param1))
         {
            return this.var_830.getItem(param1);
         }
         if(this.var_828.hasItem(param1))
         {
            return this.var_828.getItem(param1);
         }
         var _loc2_:int = 0;
