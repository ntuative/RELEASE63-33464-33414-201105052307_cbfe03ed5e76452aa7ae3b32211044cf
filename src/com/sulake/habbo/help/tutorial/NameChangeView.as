package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1533:uint = 13232628;
      ...
      private var var_1924:IWindowContainer;
      ...
      private var var_1251:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_347;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_532 = param1;
         if(this.var_1922 == this.var_532)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1924 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_811)
         {
            this.var_811 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_811)
            {
               return;
            }
            this._window.content.addChild(this.var_811);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_810)
         {
            this.var_810 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_810)
            {
               return;
            }
            this._window.content.addChild(this.var_810);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_810.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_532;
         }
         this.showView(this.var_810);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_532);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_864:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_868:
               break;
            ...
            case ChangeUserNameResultMessageEvent.var_863:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1079:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1080 || param1 == ChangeUserNameResultMessageEvent.var_1079)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1251 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1251.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1533;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_532 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_532 != _loc5_)
               {
                  this.var_1922 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_532);
               break;
