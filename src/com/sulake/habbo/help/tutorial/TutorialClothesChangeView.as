package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private var var_765:IWindowContainer;
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_33.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_57,this.onShowMenuEvent);
      ...
      {
         return TutorialUI.const_444;
      }
      
      public function dispose() : void
      {
         this.setToolbarIconHighlight(false);
         this.var_33.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_57,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_57)
         {
            ...
            this.var_33.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_581));
         }
      }
      
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_105,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_765 = this.var_33.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_765.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_33.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_57,HabboToolbarIconEnum.MEMENU_ARROW,this.var_765));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_33.showView(TutorialUI.const_90);
               }
         }
      }
   }
