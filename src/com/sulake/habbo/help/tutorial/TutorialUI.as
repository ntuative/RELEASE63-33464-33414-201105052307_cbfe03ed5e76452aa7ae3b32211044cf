package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_444:String = "TUI_CLOTHES_VIEW";
      
      public static const const_490:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_379:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_550,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_608,this.onTaskDoneEvent);
         ...
         {
            this.var_33.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_333,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1257 && this.var_1258 && this.var_1544;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_550,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_608,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_485,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
               this.var_33.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_333,this.onFigureUpdate);
            }
            this.var_33 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_43 == null || this.var_43.id == const_90)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_550:
               this.var_1544 = true;
               if(this.var_43 != null && this.var_43.id == const_490)
               {
                  this.showView(const_90);
               }
               break;
            case HabboHelpTutorialEvent.const_608:
               if(this.var_43 != null && this.var_43.id == const_444)
               {
                  this.var_1935 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2382 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_347:
               ...
               if(this.var_379 == null)
               {
                  this.var_379 = new NameChangeView(this);
               }
               this.var_379.showMainView();
               this.prepareForTutorial();
               break;
            case const_444:
         ...
         this._window.height = _loc2_.height + this.var_2381;
         this._window.width = _loc2_.width + this.var_2382;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_33.hideUI();
         this.var_33.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_127));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_43 != null && (this.var_43.id == const_347 || this.var_43.id == const_90))
         {
            this.showView(const_90);
         }
      }
      ...
      {
         this.var_1257 = true;
         if(this.var_43 != null && (this.var_43.id == const_444 || this.var_43.id == const_90))
         {
            this.showView(const_90);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_571)
         {
            this.var_1258 = true;
         ...
         {
            this.var_379.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_571)
         {
            this.var_379.checkedName = _loc2_.name;
         }
         else
         {
            this.var_379.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
