package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1515:int = HabboMusicPrioritiesEnum.const_137;
      ...
      private var var_553:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_790,this.onJukeboxInit);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_245,this.onJukeboxDispose);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_955,this.onSoundMachineInit);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_806,this.onSoundMachineDispose);
         this.var_1307 = new Timer(1000);
         this.var_1307.start();
         this.var_1307.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_294)
         {
            this.var_552[_loc6_] = null;
            this.var_844[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2037)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_377)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_238)
            {
               ...
               {
                  _loc3_ = this.var_238.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_79)
            {
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_790,this.onJukeboxInit);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_245,this.onJukeboxDispose);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_955,this.onSoundMachineInit);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_806,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_294)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_552[param1] = _loc7_;
         this.var_844[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_552[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_552[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_844[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_552.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_552[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_238.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_294)
         {
      ...
      {
         if(this.var_681.getValue(param1) == null)
         {
            this.var_681.add(param1,param2);
      ...
      {
         return this.var_394.length;
      }
      
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_394.length)
         {
            return this.var_394.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_394.length)
         {
            return this.var_394.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         {
            _loc5_ = this.var_238.getWithIndex(_loc3_) as SongDataEntry;
            _loc6_ = _loc5_.soundObject as TraxSequencer;
            if(_loc6_ != null)
            {
               _loc7_ = 0;
               while(_loc7_ < param1.length)
               {
                  if(_loc6_.traxData.getSampleIds().indexOf(param1[_loc3_]) != -1)
                  {
                     if(_loc2_.indexOf(_loc5_.id) == -1 && _loc5_.id != this.var_1308)
                     {
         ...
         {
            _loc8_ = this.var_238.getValue(_loc4_) as SongDataEntry;
            _loc8_.soundObject = null;
            Logger.log("Unloaded " + _loc8_.name + " by " + _loc8_.creator);
         }
      }
      
      public function get samplesIdsInUse() : Array
      {
         var _loc1_:SongDataEntry = this.var_238.getValue(this.var_1308);
         var _loc2_:TraxSequencer = _loc1_.soundObject as TraxSequencer;
         return _loc2_.traxData.getSampleIds();
      }
      
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         if(this.var_843.length < 1)
         {
            return;
         }
         if(this._connection == null)
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_843));
         Logger.log("Requested song info\'s : " + this.var_843);
         this.var_843 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_238.add(_loc6_.id,_loc10_);
               ...
               while(this.var_845.indexOf(_loc6_.id) != -1)
               {
                  this.var_845.splice(this.var_845.indexOf(_loc6_.id),1);
                  if(this.var_845.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_294)
         {
            return false;
         }
         ...
         this.var_2037 = this.getSongRequestCountAtPriority(param1);
         this.var_1308 = param2;
         if(this._priorityPlaying <= const_1515)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2827 != param1.id || _loc3_ > this.var_2826 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2827 = param1.id;
            this.var_2826 = _loc3_;
         }
      }
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_681.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_394.add(_loc5_,_loc6_);
            if(this.var_238.getValue(_loc6_) == null)
            {
               this.var_845.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_553 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_79,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_553 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
