package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_226:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_226 = param2;
         this.var_714 = [];
         this.var_714.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_714.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_714)
         {
         ...
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_741,this.onSoundMachinePlayEvent);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_874,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_79)
            {
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_741,this.onSoundMachinePlayEvent);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_874,this.onSoundMachineStopEvent);
               this.var_79 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_427 == param1)
         {
            this.playCurrentSongAndNotify(this.var_427);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_226.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_427 = -1;
         this.var_607 = false;
         this.var_226.stop(HabboMusicPrioritiesEnum.const_137);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_226.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_226.playSong(param1,HabboMusicPrioritiesEnum.const_137,_loc3_,0,0,0))
         {
