package com.sulake.habbo.sound
{
   ...
   public interface IHabboMusicController
   {
      ...
      function playSong(param1:int, param2:int, param3:Number = 0.0, param4:Number = 0.0, param5:Number = 0.5, param6:Number = 0.5) : Boolean;
      ...
      function method_11(param1:int) : void;
