package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1026:uint = 2577770;
      ...
      private var var_610:ItemPopupCtrl;
      ...
      private var var_1772:IWindowContainer;
      
      private var var_200:Timer;
      
      private var var_947:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_610 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_200)
            {
               this.var_200.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_200.stop();
               this.var_200 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1772 = this.createMinimizedWindow();
         }
         if(!this.var_2390)
         {
            return this.var_67;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.ownUserAccepts ? uint(const_1025) : uint(const_1026);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.otherUserAccepts ? uint(const_1025) : uint(const_1026);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_200 = new Timer(1000,3);
            this.var_200.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_200.reset();
         this.var_200.repeatCount = 3;
         this.var_200.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_200.currentCount));
         if(this.var_200.currentCount == 3)
         {
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1804)
            {
            ...
            this.var_610.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_488);
            this.var_610.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_610.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_178.push(param4);
            this.var_178.push(param1);
            this.var_178.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_178.length > 0)
         {
            _loc2_ = this.var_178.pop();
            _loc3_ = this.var_178.pop();
            _loc4_ = uint(this.var_178.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_17.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_17.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_610.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_488);
               }
            }
            else
            {
               this.var_178.push(_loc4_);
               this.var_178.push(_loc3_);
