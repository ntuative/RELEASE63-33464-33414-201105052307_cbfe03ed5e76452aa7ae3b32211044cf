package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1795:uint = 9;
      
      public static const const_199:uint = 0;
      
      public static const const_224:uint = 1;
      
      public static const const_429:uint = 2;
      
      public static const const_307:uint = 3;
      
      public static const const_513:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1029 = new Map();
         this.var_1271 = false;
         this.var_1853 = param6;
         this.var_719 = true;
         this.state = const_224;
         this.var_55.setup(param1,param3,param4,param6);
         this.var_55.updateItemList(this.var_822);
         this.var_55.updateItemList(this.var_1562);
      ...
      public function close() : void
      {
         if(this.var_719)
         {
            if(this._state != const_199 && this._state != const_240)
            {
      ...
      {
         this.var_55.setMinimized(param1 != InventoryCategory.const_81);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_821 + " OTHER: " + this.var_1271);
         ...
         {
            case const_199:
               if(param1 == const_224 || param1 == const_240)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_276 == null || this.var_276.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         ...
         {
            _loc2_ = this.var_276.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_55.alertPopup(TradingView.const_1110);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_822)
            {
               this.var_821 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1271 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_55.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_822)
            {
               this.var_55.alertPopup(TradingView.const_1156);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_276.length < const_1795)
         {
