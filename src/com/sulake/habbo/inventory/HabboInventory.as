package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2191:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this._roomSessionManager != null)
         {
            ...
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_91,this.roomSessionEventHandler);
            this._roomSessionManager.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_610,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_50.getValue(InventoryCategory.const_81));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_50.getValue(InventoryCategory.const_797));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_50.getValue(InventoryCategory.const_326));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_50.getValue(InventoryCategory.const_424));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_50.getValue(InventoryCategory.const_146));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_50.getValue(InventoryCategory.const_440) as MarketplaceModel;
      }
      ...
      {
         return this.var_104.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_104.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_104.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_104.clubHasEverBeenMember;
      }
      ...
      {
         this.var_104.clubPeriods = param1;
         this.var_104.clubDays = param2;
         this.var_104.clubHasEverBeenMember = param3;
         this.var_104.isVIP = param4;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1597 = new IncomingMessages(this);
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomSessionManager.events.addEventListener(RoomSessionEvent.const_91,this.roomSessionEventHandler);
         this._roomSessionManager.events.addEventListener(RoomSessionPropertyUpdateEvent.const_610,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_91:
               this.var_1265 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_610:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_387 || !this._config || !this._catalog || !this._avatarRenderer || !this._roomSessionManager || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_50.add(InventoryCategory.const_440,_loc1_);
         ...
         this.var_50.add(InventoryCategory.const_797,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_387);
         this.var_50.add(InventoryCategory.const_424,_loc5_);
         ...
         this.var_50.add(InventoryCategory.const_146,_loc8_);
         this.var_1057 = [];
         this.var_1056 = [];
         this.var_194 = true;
         if(this.var_2841)
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2191);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_746));
      }
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_1057.indexOf(_loc2_) == -1)
            {
               this.var_1057.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_1056.indexOf(_loc2_) == -1)
            {
               this.var_1056.push(_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:int = this.var_1057.length + this.var_1056.length;
         if(_loc1_ != this.var_2840)
         {
            this.var_2840 = _loc1_;
      ...
      public function resetUnseenItems(param1:int) : void
      {
         ...
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_877:
               if(this.var_1057.length > 0)
               {
               ...
               break;
            case UnseenItemCategoryEnum.const_736:
               if(this.var_1056.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(param1));
                  this.var_1056 = [];
                  _loc3_ = true;
