package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2193:int = 0;
      
      private const const_1085:int = 1;
      
      private const const_1870:int = 2;
      
      private const const_1869:int = 3;
      
      private const const_1867:int = 42;
      
      private const const_1868:int = 120;
      ...
      private var var_733:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_429.add(FurniModel.const_46,new FurniGridView(this.var_66,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_429.add(FurniModel.const_49,new FurniGridView(this.var_66,FurniModel.const_49,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_429.getValue(this.var_428);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_66.getCategoryContent(this.var_428);
         if(!this.var_66.isListInited())
         {
            _loc2_ = this.const_1085;
         }
         ...
         if(this.var_2371 == _loc2_)
         {
            return;
         }
         this.var_2371 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_46,FurniModel.const_49];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_429.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_429.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_429.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_66.getGroupItemInIndex(_loc3_,this.var_428);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_215);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_207);
            ...
            if(_loc5_.category == FurniCategory.const_311)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_733 && this.var_733.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1245)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1868)
         {
            _loc3_ = this.const_1868;
         }
         else if(_loc3_ < this.const_1867)
         {
            _loc3_ = this.const_1867;
         }
         else
         {
