package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private var var_2893:XML;
      
      private var var_1075:IWindowContainer;
      
      private var var_1275:Boolean;
      
      private var var_691:Timer;
      
      private var var_2879:Boolean;
      
      private var _catalog:IHabboCatalog;
      
      private var var_2089:Vector.<Array>;
      
      private var var_2090:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_691 = new Timer(const_1540,1);
         this.var_691.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2893 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_191,this.onObjectPlaced);
               }
            ...
            {
               this.var_691.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_691.stop();
               this.var_691 = null;
            }
            if(this.var_215 != null)
            {
               this.var_215.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_215.stop();
               this.var_215 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_2089 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2089;
            }
            else
            {
               if(this.var_2090 == null)
               {
                  this.var_2090 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2090;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_311)
         {
         ...
         if(this.var_1075 == null)
         {
            this.var_1075 = this._windowManager.buildFromXML(this.var_2893) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_1075.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_215 = new Timer(param1,1);
            this.var_215.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_215.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_81 && this._controller.isVisible)
         {
            ...
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_49:
                  ...
                  break;
               case CATEGORY_PETS:
                  this._controller.toggleInventoryPage(InventoryCategory.const_146);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_440);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_690.add(const_46,new Array());
         this.var_690.add(const_49,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            for(; _loc9_ < _loc7_.length; _loc9_++)
            {
               ...
               if(_loc8_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_212)
                  {
                     _loc6_ = _loc8_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == CATEGORY_PETS)
            {
               ...
               {
                  this._controller.petsModel.switchToFurnitureCategory(_loc5_,true);
               }
            }
            else
            {
      ...
      {
         return getTimer() < this.var_2892 + const_1539;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_337;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_312 || _loc3_.category == FurniCategory.const_311 || _loc3_.category == FurniCategory.const_341)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_690.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_690.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_719)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      private function resetUnseenItems() : void
      {
         this._controller.resetUnseenItems(UnseenItemCategoryEnum.const_877);
         this._controller.resetUnseenItems(UnseenItemCategoryEnum.const_736);
      }
   }
}
