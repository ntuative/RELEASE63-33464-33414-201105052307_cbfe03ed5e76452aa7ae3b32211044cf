package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_268:IItemGridWindow;
      ...
      private var var_218:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_268 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_218);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_640.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_268.removeGridItem(_loc2_.window);
         if(this.var_218 == _loc2_)
         {
            this.var_218 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_640 == null || this.var_640.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_640.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_640.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_268.addGridItem(_loc2_.window);
            this.var_640.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_218.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_59)
         {
            ...
            {
               case "tab_floor":
                  this.var_66.switchToFurnitureCategory(FurniModel.const_46);
                  break;
               case "tab_wall":
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_218 != null)
         {
            this.var_218.setSelected(false);
         }
         this.var_218 = param1;
         if(this.var_218 != null)
         {
            this.var_218.setSelected(true);
         }
