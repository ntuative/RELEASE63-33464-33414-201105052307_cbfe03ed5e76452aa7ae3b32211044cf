package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_1325:Dictionary;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_467.running);
         this.var_1325[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1325[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_387.getBadgeImage(param2.badgeId);
            this.var_1325[param2.badgeId] = _loc4_;
         }
