package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1123:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1692 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1123 = this.var_1692.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1123)
         {
            this.var_1123.procedure = this.onButtonClick;
         }
         this.var_1122 = this.var_1692.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1122)
         {
            this.var_1122.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_249 >= this.var_57.length - 1)
         {
            this.var_1122.disable();
         }
         else
         {
            this.var_1122.enable();
         }
         if(this.var_249 <= 0)
         {
            this.var_1123.disable();
         }
         else
         {
            this.var_1123.enable();
         }
      }
      ...
      {
         ++this.var_249;
         this.var_249 = Math.min(this.var_249,this.var_57.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_249;
         this.var_249 = Math.max(this.var_249,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_57[this.var_249][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_57[this.var_249][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_57[this.var_249][1]).value;
