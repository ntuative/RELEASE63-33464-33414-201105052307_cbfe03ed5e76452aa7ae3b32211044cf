package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class MoveFurni implements ActionType
   {
      ...
      {
         return ActionTypeCodes.var_2124;
      }
      ...
      {
         return UserDefinedRoomEventsCtrl.var_332;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         var _loc3_:int = this.getMoveSelector(param1).method_1().id;
         var _loc4_:int = this.getRotateSelector(param1).method_1().id;
         _loc2_.push(_loc3_);
         _loc2_.push(_loc4_);
         return _loc2_;
      }
