package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1215,param1);
         this.var_982 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_982);
         }
      ...
      {
         return int(this.var_1862 * (Number(param1 - this._minValue) / (this.var_1215 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1862 * (this.var_1215 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_981)
         {
            if(param1.type == WindowMouseEvent.const_52 || param1.type == WindowMouseEvent.const_200)
            {
               this.var_981 = false;
            }
         }
         if(!this.var_981 || param1.type != WindowEvent.const_285)
         {
            return;
         }
         if(this.var_637 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_637 != 0)
            {
               _loc3_ = this.var_982 + this.var_637;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_788 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_788.width,this.var_788.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_788,this.var_788.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_789 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_789.width,this.var_789.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_789,this.var_789.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1862 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_788 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_789 = BitmapData(_loc2_.content);
      }
   }
}
