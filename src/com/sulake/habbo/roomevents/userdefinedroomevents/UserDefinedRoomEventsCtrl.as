package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_332:int = 3;
      
      private static var var_1606:int = 2;
      ...
      private var var_2071:TriggerConfs;
      
      private var var_2070:ActionTypes;
      
      private var var_2069:ConditionTypes;
      
      private var var_283:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_855:RoomObjectHightLighter;
      
      private var var_120:UserDefinedRoomEventsHelp;
      
      private var var_1323:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2071 = new TriggerConfs();
         this.var_2070 = new ActionTypes();
         this.var_2069 = new ConditionTypes();
         this.var_283 = new Dictionary();
         super();
         this.var_79 = param1;
         this.var_855 = new RoomObjectHightLighter(param1);
         this.var_120 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_51 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_51,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_51,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_51,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_51,"apply_snapshot_txt"),this.onApplySnapshot);
         Util.setProcDirectly(this.find(this.var_51,"dec_stuff_sel_txt"),this.onDecStuffSelectionType);
         Util.setProcDirectly(this.find(this.var_51,"inc_stuff_sel_txt"),this.onIncStuffSelectionType);
         this.find(this.var_51,"dec_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_51,"inc_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_51,"helplink").mouseThreshold = 0;
         this.find(this.var_51,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1323 = new SliderWindowController(this.var_79,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_79.assets,0,20,1);
         this.var_1323.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1323.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_855.hideAll(this.var_283);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_855.showAll(this.var_283);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1323.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_36.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_332)
            {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_51.findChildByName("select_furni_container"));
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1323.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_120.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1606) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1606 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_332)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2071);
         this.refreshConfigureElement(this.var_2070);
         this.refreshConfigureElement(this.var_2069);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         {
            this.find(this.var_51,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_51,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_51,3,5);
         this.var_51.height = Util.getLowestPoint(this.var_51) + 1;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_51,"header_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_51,"action_inputs_container"));
         if(this.var_36 as ActionDefinition == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_51,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_51,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_51.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_51.findChildByName("custom_inputs_container"));
      ...
      {
         return ICheckBoxWindow(this.var_51.findChildByName("furni_type_matches_checkbox"));
      }
      
      private function getDecStuffSelTxt() : IWindow
      {
         return this.var_51.findChildByName("dec_stuff_sel_txt");
      }
      
      private function getIncStuffSelTxt() : IWindow
      {
         return this.var_51.findChildByName("inc_stuff_sel_txt");
      }
      
      private function getFurniTypeMatchesText() : IWindow
      {
         return this.var_51.findChildByName("furni_type_matches_txt");
      }
   }
}
