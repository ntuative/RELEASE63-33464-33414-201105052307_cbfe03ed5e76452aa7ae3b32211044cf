package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1360:String = "visit_btn_click";
      
      private static const const_1359:String = "chat_btn_click";
      
      private static const const_1361:String = "find_friends_btn_click";
      
      private static const const_995:String = "Toolbar";
      
      private static const const_994:String = "open";
      
      private static const const_993:String = "close";
      
      private static const const_1357:String = "FRIENDLIST";
      
      private static const const_1358:String = "MESSENGER";
       
      
      private var var_81:IHabboCommunicationManager;
      
      private var var_295:IHabboFriendList;
      
      private var var_418:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_81)
            {
               this.var_81.release(new IIDHabboCommunicationManager());
               this.var_81 = null;
            }
            if(this.var_295)
            {
               this.var_295.release(new IIDHabboFriendList());
               this.var_295 = null;
            }
            if(this.var_418)
            {
               this.var_418.release(new IIDHabboMessenger());
               this.var_418 = null;
            }
            this.var_128 = null;
      ...
      {
         return this.var_296.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_81)
         {
            this.var_81.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_81.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_654,const_655,const_1360));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_418)
         {
            this.var_418.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_81)
            {
               this.var_81.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_654,const_655,const_1359));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_81)
         {
            this.var_81.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_81.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_654,const_655,const_1361));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_295)
         {
            if(!this.var_295.disposed)
            {
               if(!this.var_295.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_295.openFriendRequests();
                  }
                  else
                  {
                     this.var_295.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_295.mainWindow;
                  if(_loc1_ != null && WindowToggle.isHiddenByOtherWindows(_loc1_,_loc1_.desktop))
                  {
                     _loc1_.activate();
                     return;
                  }
               ...
               if(this.var_81)
               {
                  this.var_81.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_995,const_1357,!!this.var_295.isOpen() ? const_994 : const_993));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_418)
         {
            if(!this.var_418.disposed)
            {
               this.var_418.toggleMessenger();
               if(this.var_81)
               {
                  this.var_81.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_995,const_1358,!!this.var_418.isOpen() ? const_994 : const_993));
               }
            }
         }
      }
      ...
      {
         this.var_81 = param2 as IHabboCommunicationManager;
         this.var_81.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_81.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_81.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
         this.var_81.addHabboConnectionMessageEvent(new NewBuddyRequestEvent(this.onNewFriendRequest));
         this.var_81.addHabboConnectionMessageEvent(new BuddyRequestsEvent(this.onFriendRequestList));
         this.var_81.addHabboConnectionMessageEvent(new NewConsoleMessageEvent(this.onNewConsoleMessage));
         this.var_81.addHabboConnectionMessageEvent(new RoomInviteEvent(this.onRoomInvite));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_418 = param2 as IHabboMessenger;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_295 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_296.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_296.remove(_loc8_);
               this.var_128.splice(this.var_128.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_296.getValue(_loc4_.id);
            if(_loc3_)
            {
               if(_loc4_.online || const_302)
               {
                  ...
                  _loc3_.method_5 = _loc4_.followingAllowed;
            ...
            else if(_loc4_.online || const_302)
            {
               ...
               this.var_128.push(_loc3_);
               this.var_296.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_302)
            {
               if(this.var_296.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
                  this.var_128.push(_loc3_);
                  this.var_296.add(_loc3_.id,_loc3_);
         ...
         {
            this.var_128 = !!const_302 ? this.sortByNameAndOnlineStatus(this.var_128) : this.sortByName(this.var_128);
         }
