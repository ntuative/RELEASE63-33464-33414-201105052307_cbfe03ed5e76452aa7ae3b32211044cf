package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_718 = (param2 & 0) > 0;
         this.var_895 = new Dictionary();
         if(!this.var_718)
         {
            lock();
         }
         ...
         this.var_587 = this.getKey("url_prefix");
         if(this.var_587 != null && this.var_587.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_587 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_587 = this.getKey("url.prefix");
         if(this.var_587.length > 0)
         {
            externalAccessDomain = this.var_587.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_895[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_895[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_587);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         if(param4)
         {
            if(this.var_895[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1661.indexOf(param1) < 0 || param3)
         {
            this.var_895[param1] = param2;
         }
         if(param3)
         {
            this.var_1661.push(param1);
         }
      }
      ...
      {
         var _loc3_:String = this.var_895[param1] as String;
         if(_loc3_ == null)
         {
            return param2;
         }
