package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarViewStatic implements IToolbarView
   {
      ...
      private static const const_1535:uint = 7433577;
      
      private static const const_1536:uint = 5723213;
      
      private static const const_467:String = "_hover";
      
      private static const const_468:String = "_normal";
      
      private static const const_1083:int = 5;
      ...
      public function ToolbarViewStatic(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         {
            this.setIconHoverState(_loc11_,const_468);
         }
         ...
         param6.addEventListener(HabboToolbarEvent.const_362,this.onToolbarStateEvent);
         param6.addEventListener(HabboToolbarEvent.const_324,this.onToolbarStateEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._events)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_362,this.onToolbarStateEvent);
            this._events.removeEventListener(HabboToolbarEvent.const_324,this.onToolbarStateEvent);
            this._events = null;
         }
         if(this._catalog != null)
         {
      ...
      private function onToolbarStateEvent(param1:HabboToolbarEvent) : void
      {
         switch(param1.type)
         {
            case HabboToolbarEvent.const_362:
               this.iconVisibility("QUESTS",false);
               this.iconVisibility("MEMENU",false);
               this.iconVisibility("INVENTORY",false);
               break;
            case HabboToolbarEvent.const_324:
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_467 ? this.var_1610 : this.var_1611;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_467)
         {
            param1.color = const_1535;
         }
         else
         {
            param1.color = const_1536;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1611 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1610)
         {
            this.var_1610.dispose();
         }
         this.var_1610 = this.addShadow(param1,new Point(4,5),4281150249);
      }
      ...
      {
         var _loc3_:IWindow = this.getUnseenItemCounter(param1);
         if(!_loc3_)
         {
            return;
         }
         ...
         {
            this.removeUnseenItemCounter(param1);
         }
      }
      
      public function getUnseenItemCounter(param1:String) : IWindow
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         ...
         var _loc2_:IWindowContainer = this.var_1609.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1083;
            _loc2_.y = const_1083;
            this.var_1609.add(param1,_loc2_);
         }
         return _loc2_.findChildByName("count");
      }
      
      public function removeUnseenItemCounter(param1:String) : void
      {
         var _loc2_:IWindow = this.getUnseenItemCounter(param1);
         _loc2_.dispose();
         this.var_1609.remove(param1);
      }
