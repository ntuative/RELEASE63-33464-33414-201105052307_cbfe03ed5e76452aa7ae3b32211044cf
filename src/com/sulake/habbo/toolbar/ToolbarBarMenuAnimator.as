package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_237:Boolean = true;
      
      private static const const_1486:Number = 25;
      
      private static const const_1509:Number = 90;
      
      private static const const_1064:int = 50;
      
      private static const const_1487:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1543:IToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:IToolbarView)
      {
         ...
         this.var_814 = new Timer(const_1486);
         this.var_814.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < this.var_378.length)
         {
            this.repositionWindow(this.var_378[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1064 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1064 || param1.desktop.height - param1.y < const_1487;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1543.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_378.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1543.getIconLoc(param1.iconId);
      ...
      {
         return this.var_660[this.var_658.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_658[this.var_660.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_658.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_658.splice(_loc3_,1);
            this.var_660.splice(_loc3_,1);
         }
         this.var_660.push(param1.name);
         this.var_658.push(param2);
         param1.addEventListener(WindowEvent.const_285,this.windowEventListener);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_659[_loc3_] == null)
            {
               this.var_659[_loc3_] = new Array();
            }
            if(this.var_659[_loc3_].indexOf(param1) < 0)
            {
               this.var_659[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_378.indexOf(param1) > -1)
         {
            if(const_237)
            {
            ...
            else
            {
               ...
               this.var_378.splice(this.var_378.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_660.length)
         {
            if(this.var_660[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_658[_loc2_];
               if(this.var_659[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_659[_loc3_].length)
                  {
                     this.repositionWindow(this.var_659[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_378.length)
         {
            _loc2_ = this._itemList[this.var_378[_loc7_]];
            if(_loc2_.active)
            {
