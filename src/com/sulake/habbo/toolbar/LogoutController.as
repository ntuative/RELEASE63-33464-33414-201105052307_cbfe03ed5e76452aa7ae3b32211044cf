package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private static const const_1544:String = "HELP";
      
      private static const const_1542:String = "ROOMINFO";
      ...
      public function LogoutController(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_312 = this._window.findChildByName("roominfo_region");
         ...
         this.hideRoomInfo();
         this.var_2096 = this._config.getKey("roominfo.widget.enabled") == "1";
         if(this.var_2096)
         {
            this._events.addEventListener(HabboToolbarEvent.const_324,this.onRoomView);
            this._events.addEventListener(HabboToolbarEvent.const_362,this.onHotelView);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_2096)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_324,this.onRoomView);
            this._events.removeEventListener(HabboToolbarEvent.const_362,this.onHotelView);
         }
         this._events = null;
         this._config = null;
         if(this._window)
      ...
      {
         this._list.removeListItem(this.var_312);
      }
      
      private function showRoomInfo() : void
      {
         this._list.addListItemAt(this.var_312,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_476;
         _loc3_.y = this.const_634;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_696)
         {
            this.var_696 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1544);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1542);
               break;
            case "confirm":
               if(false)
               {
