package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1434:LogoutController;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_275.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_944 = this._config.getKey("client.toolbar.static.enabled","false") == "true";
         this.tryInitialize();
      }
      
      private function tryInitialize() : void
      {
         if(this.var_275 && this._windowManager && this._config)
         {
            this.var_275.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1434 = new LogoutController(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_135,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1323,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_187,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_105,this.onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_57,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_482,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1263,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1202,this.onHideWindowEvent);
         this._state = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_72));
      }
