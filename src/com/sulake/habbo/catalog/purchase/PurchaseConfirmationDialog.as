package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_589:IWindowContainer;
      
      private var var_343:int = -1;
      
      private const const_2135:int = 10;
      ...
      private const const_1873:uint = 4.293848814E9;
      
      private const const_1874:uint = 4.294967295E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1668 = _loc1_.stuffTypes;
            this.var_724 = _loc1_.boxTypes;
            this.var_725 = _loc1_.ribbonTypes;
            this.var_1111 = this.var_1668[0];
            this.var_341 = this.var_724[0];
            this.var_342 = this.var_725[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_342 < 0)
         {
            this.var_342 = this.var_725.length - 1;
         }
         if(this.var_342 > this.var_725.length - 1)
         {
            this.var_342 = 0;
         }
         if(this.var_341 < 0)
         {
            this.var_341 = this.var_724.length - 1;
         }
         if(this.var_341 > this.var_724.length - 1)
         {
            this.var_341 = 0;
         }
         var _loc1_:int = this.var_724[this.var_341] * 1000 + this.var_725[this.var_342];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1111,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1387 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1668;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1111);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_724[this.var_341]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_725[this.var_342]);
         this._catalog.purchaseProductAsGift(this.var_1388,this.var_90,this.var_1389,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1388,this.var_90.offerId,this.var_1389);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               if(this.var_2228 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_229)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_2135)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2228 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_360:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_343 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_343 + 1);
                     break;
      ...
      {
         if(this.var_246 == null || !this.var_246.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_246.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_343) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_246 == null)
         {
            this.var_246 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_589 == null)
         {
            this.var_589 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_589.procedure = this.suggestionsEventHandler;
         }
         if(this.var_246 == null || this.var_589 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_246.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_589.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_343) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_343);
         }
         this.var_343 = param1;
         if(this.var_343 < 0)
         {
            this.var_343 = _loc2_.numListItems - 1;
         }
         if(this.var_343 >= _loc2_.numListItems)
         {
            this.var_343 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_343) as IWindowContainer;
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1873) : uint(this.const_1874);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_246.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1111;
               }
            }
            _loc4_++;
         }
