package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2162:int = 40;
      
      private const const_2161:int = 10;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_527)
         {
            this.var_527.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_527 = null;
         }
      }
      ...
      public function updateStats() : void
      {
         ...
         var _loc5_:ISelectableWindow = _loc4_.method_1();
         if(!_loc5_)
         {
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_808 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_808 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_808));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_650)
         {
            ...
            this.var_650 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_650)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1863,_loc2_.length);
         if(!this.var_527)
         {
            this.var_527 = new Timer(25);
            this.var_527.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1246 = 0;
         this.populateList();
         this.var_527.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1246 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1246));
            ++this.var_1246;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_650 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_650.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1862);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_808.length)
         {
            _loc4_ = this.var_808[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_104)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2161;
                  break;
               case "search_input":
                  _loc8_ = this.const_2162;
                  break;
               default:
                  return;
            }
