package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_209[this.var_535][this.var_643];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_535 = var_480.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_535];
         var _loc3_:Array = this.var_209[this.var_535] as Array;
         ...
         events.dispatchEvent(new CatalogWidgetColoursEvent(_loc4_,"ctlg_clr_40x32_1","ctlg_clr_40x32_2","ctlg_clr_40x32_3",this.var_643));
      }
      
      override public function startDragAndDrop(param1:IGridItem) : Boolean
      {
         var _loc2_:Array = this.var_209[this.var_535] as Array;
         var _loc3_:Offer = _loc2_[this.var_643] as Offer;
         if(_loc3_ != null)
         {
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_643 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_643] as Offer;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var_480.destroyGridItems();
         this.populateItemGrid();
         var _loc1_:Array = this.var_209[this.var_535] as Array;
         var _loc2_:Offer = _loc1_[this.var_643] as Offer;
         var_218 = _loc2_.productContainer as ProductGridItem;
         var_218.activate();
      }
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_381 || _loc1_.pricingModel == Offer.const_416)
            {
