package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1412:int = 18;
      ...
      private var var_202:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_512 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_512 < 8)
         {
            return false;
         }
         this.var_2432 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_202 != null && this.var_202.length > 0)
         {
            this.var_358 = this.var_202[0];
         }
         else
         {
            this.var_358 = -1;
         }
         this._offers.add(this.var_512,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_202 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1412 && _loc2_ < this.var_202.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_512,this.var_202[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_202 != null && this.var_202.length > 0)
         {
            ...
            this.var_358 = this.var_202[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_512,this.var_358),this.getRaceLocalizationKey(this.var_512,this.var_358));
            }
         }
         return this.getRaceLocalizationKey(this.var_512,this.var_358);
      }
