package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1856:Point;
      
      private var var_520:IItemGridWindow;
      
      private var var_1487:IScrollbarWindow;
      
      protected var var_1929:XML;
      
      private var var_2583:Array;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_978 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1212 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1856 = new Point(this.var_83.x,this.var_83.y);
         this.var_520 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1487 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_520 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1929 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         this.var_1855 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_978.text = _loc4_;
         this.var_1212.text = _loc5_;
         this.var_978.height = this.var_978.textHeight + 5;
         this.var_1212.y = this.var_978.y + this.var_978.height;
         this.var_1212.height = Math.max(130,this.var_1212.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_500:
                  _loc6_ = this.var_1855.clone();
                  if(this.var_520 != null)
                  {
                     this.var_520.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_520,this.var_1487,this.var_1929);
                     this.var_520.scrollV = 0;
                  }
                  break;
               case Offer.const_381:
               case Offer.const_416:
                     ...
                     case ProductTypeEnum.const_195:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_320,AvatarAction.const_629);
                              _loc16_.appendAction(AvatarAction.const_366,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2583)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2583 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1856.x;
            this.var_83.y = this.var_1856.y;
            if(param3 != null)
            {
