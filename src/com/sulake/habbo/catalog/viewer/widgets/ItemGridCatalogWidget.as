package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_480:IItemGridWindow;
      
      protected var var_1929:XML;
      
      protected var var_218:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_792,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_278,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_914,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_200.stop();
            this.var_200.removeEventListener(TimerEvent.TIMER,this.populateItemGrid);
            this.var_200 = null;
         }
         if(this.var_480 != null)
         {
            this.var_480.destroyGridItems();
            this.var_480 = null;
         }
         this.var_1929 = null;
         this.var_218 = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_480 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_827 >= 0 && this.var_827 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_827];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_827;
            if(this.var_827 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1929) as IWindowContainer;
         this.var_480.addGridItem(_loc2_);
         ...
         {
            ++this.var_2002;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2002);
         }
      }
