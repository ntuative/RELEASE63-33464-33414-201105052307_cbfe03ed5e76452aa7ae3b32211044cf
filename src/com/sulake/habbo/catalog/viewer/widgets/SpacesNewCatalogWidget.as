package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_434.numSelectables)
            {
               _loc3_ = this.var_434.getSelectableAt(_loc2_);
      ...
      {
         var _loc2_:int = this.var_643[this.var_535];
         var _loc3_:Offer = this.var_209[this.var_535][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_480.numGridItems)
         {
            _loc2_ = this.var_209[this.var_535][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_643[this.var_535] = (this.var_209[this.var_535] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_643[0];
         var _loc2_:int = this.var_643[1];
         var _loc3_:int = this.var_643[2];
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_209[this.var_535],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_643[this.var_535];
