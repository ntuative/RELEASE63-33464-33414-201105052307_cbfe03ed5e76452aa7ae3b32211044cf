package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1087:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_268:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1087).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1087).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_88,MouseCursorType.const_910);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_910);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_268.select(this);
            this.var_638 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_638 != null && this.var_638 == param2)
         {
            _loc3_ = this.var_268.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_638 = null;
            }
