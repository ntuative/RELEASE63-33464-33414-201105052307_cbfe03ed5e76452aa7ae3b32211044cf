package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1265:IRoomSession;
      ...
      private var var_1973:Boolean = true;
      
      private var var_186:CatalogViewer;
      
      private var var_386:ICatalogNavigator;
      
      private var var_104:Purse;
      
      private var var_91:RecyclerLogic;
      
      private var var_137:IMarketPlace;
      ...
      private var var_2758:Boolean = true;
      
      private var var_2759:Boolean = true;
      
      private var var_1971:Boolean = false;
      
      private var var_2757:GiftWrappingConfiguration;
      
      private var var_1274:ClubGiftController;
      
      private var var_539:ClubBuyController;
      
      private var var_824:Map;
      
      private var var_1275:Boolean = false;
      
      private var var_1036:IPurchasableOffer;
      
      private var var_1564:IDragAndDropDoneReceiver;
      
      private var var_64:PlacedObjectPurchaseData;
      
      private const const_1007:Point = new Point(100,20);
      
      public function HabboCatalog(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_824 = new Map();
         super(param1,param2,param3);
         this.var_104 = new Purse();
      ...
      override public function dispose() : void
      {
         ...
         {
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_85,this.onRoomSessionEvent);
            this._roomSessionManager.events.removeEventListener(RoomSessionEvent.const_91,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1653);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_104.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_104.getActivityPointsForType(param1.activityPointType))
         {
         ...
         {
            this.var_539.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_191,this.onObjectPlaced);
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_386.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_183.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_183.getKey("link.format.credits","/credits");
      ...
      {
         var _loc2_:Array = this.var_824.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_104.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_104.getActivityPointsForType(Purse.const_213)));
         var _loc1_:int = 0;
         if(!this.var_104.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_104.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_104.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_104.clubPeriods));
         }
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         else if(!WindowToggle.isHiddenByOtherWindows(this._mainContainer,this._mainContainer.desktop))
         {
            this.hideMainWindow();
         }
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_57,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
            events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(this.var_91 != null && this.getCurrentLayoutCode() == "recycler")
            {
         ...
         this.setupInventoryForRecycler(this.var_91.active && this.mainWindowVisible());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_186.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_386 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_186 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_186.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1007;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1971 = param1.session.isPrivateRoom;
               this.var_1265 = param1.session;
               if(this.var_91 != null)
               {
                  this.var_91.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_91:
               ...
               if(this.var_91 != null)
               {
                  this.var_91.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_91 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_137 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1274 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_539 == null)
         {
            this.var_539 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_186 != null)
         {
            this.var_186.catalogWindowClosed();
         }
         if(this.var_91 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_91.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_386.buildCatalogIndex(_loc2_);
         if(this.var_823 && this.var_823 != "")
         {
            this.var_386.openPage(this.var_823);
            this.var_823 = "";
            this.var_1037 = -1;
         }
         else if(this.var_1037 > -1)
         {
            this.var_386.openPageById(this.var_1037,this.var_1972);
            this.var_1037 = -1;
            this.var_1972 = -1;
            this.var_823 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_186.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_186.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_104.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2758 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1276);
         }
         this.var_2758 = false;
         if(this.var_317 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_74,this.var_104.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_104.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2759 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1160);
         }
         this.var_2759 = false;
         if(this.var_317 != null)
         {
         ...
         if(_loc2_.type == Purse.const_213)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_104.activityPoints = _loc2_.points;
         this.updatePurse();
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_104.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_104.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_104.isVIP = _loc2_.isVIP;
         this.var_104.pastClubDays = _loc2_.pastClubDays;
         this.var_104.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1274.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_91 == null)
         {
            return;
         }
         this.var_91.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_91.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_91.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_186.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_137 != null)
         {
            this.var_137.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_137 != null)
         {
            this.var_137.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_137 != null)
         {
            this.var_137.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2757 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_137.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_824.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_824.add(_loc2_.productCode,_loc3_.slice());
            this.var_186.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_183.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_183.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_189)
         {
            _loc3_ = this.var_183.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_183.keyExists("catalog.drag_and_drop") || this.var_183.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1265 || !this.var_1265.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_215);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_207);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1275 && param1.type == RoomEngineObjectEvent.const_191)
         {
            ...
            _loc3_ = this.var_1036.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_64 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_1036);
            _loc5_ = this.var_1564;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_327,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_215);
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_207);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_214);
         if(this.var_64 && this.var_64.productClassId == param1.classId)
         {
            if(this.var_64.roomCategory == this._roomEngine.activeRoomCategory && this.var_64.roomId == this._roomEngine.activeRoomId)
            {
               ...
               _loc6_ = this.var_64.category;
               _loc7_ = this.var_64.wallLocation;
               _loc8_ = this.var_64.x;
               _loc9_ = this.var_64.y;
               _loc10_ = this.var_64.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_312:
                     if(this.var_64.extraParameter != _loc3_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
                  case FurniCategory.const_311:
                     if(this.var_64.extraParameter != _loc2_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
                  case FurniCategory.const_341:
                     if(this.var_64.extraParameter != _loc4_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_183.getKey("image.library.catalogue.url");
