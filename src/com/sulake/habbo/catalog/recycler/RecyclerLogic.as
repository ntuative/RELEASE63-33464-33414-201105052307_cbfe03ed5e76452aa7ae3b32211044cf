package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1038:int = 0;
      ...
      {
         return this.var_627 != const_1038;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1818 != RecyclerStatusMessageEvent.const_1222;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_627 == const_458;
      }
      ...
      {
         this.var_627 = const_1039;
         this.var_116 = new Array(const_217);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1618:
               this.var_627 = const_458;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1222:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1686:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1259:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1720:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_116.length < const_217)
         {
            return false;
         }
         var _loc1_:int = 0;
