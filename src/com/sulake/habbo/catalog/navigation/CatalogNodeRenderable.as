package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1346:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1374:XML;
      
      private static var var_1373:XML;
       
      
      private var var_1651:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2952:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1651 == 4294967295)
            {
               this.var_1651 = _loc1_.color;
            }
            _loc1_.color = const_1346;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1847;
            }
         }
      }
      ...
      {
         this._list = navigator.catalog.windowManager.buildFromXML(var_1373) as IItemListWindow;
         if(this._list == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1374) as IWindowContainer;
         }
         else
         {
