package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_826:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_454 != null)
         {
            ...
            {
               _loc2_ = this.var_454.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_324 != null)
         {
            ...
            {
               _loc2_ = this.var_324.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_472,RoomWidgetChatSelectAvatarMessage.const_984];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_472:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1229))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1229))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_984:
      ...
      {
         return [RoomSessionChatEvent.const_211];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_211:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_324.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_454.getValue(_loc16_) as BitmapData;
                           }
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_209)
                                    {
                                       this.var_324.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_454.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1284 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1284);
            }
            if(this.var_826 == null)
            {
               ...
               this.var_541.y = 0;
               this.var_541.z = 0;
               this.var_826 = _loc4_.getScreenPoint(this.var_541);
               this.var_1284 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_541.x = 0;
            this.var_541.y = 0;
            this.var_541.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_541);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_826.x || _loc8_.y != this.var_826.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_826,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_324)
         {
            _loc2_ = this.var_324.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_454)
         {
            _loc2_ = this.var_454.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1285.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1991.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1991.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_324)
            {
               this.var_324.add(_loc3_,param2);
            }
         }
      }
   }
