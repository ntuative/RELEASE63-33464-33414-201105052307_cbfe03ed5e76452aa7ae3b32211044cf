package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_388;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_722);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_730);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_700);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_722:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_730:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_700:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_140);
         _loc1_.push(FriendRequestEvent.const_62);
         _loc1_.push(FriendRequestEvent.const_335);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_140:
               ...
               break;
            case FriendRequestEvent.const_62:
            case FriendRequestEvent.const_335:
