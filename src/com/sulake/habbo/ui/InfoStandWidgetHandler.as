package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_226.events.addEventListener(NowPlayingEvent.const_101,this.onNowPlayingChanged);
            this.var_226.events.addEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_144,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_144,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_620.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_620.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_226 != null)
         {
            this.var_226.events.removeEventListener(NowPlayingEvent.const_101,this.onNowPlayingChanged);
            this.var_226.events.removeEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
            this.var_226 = null;
         }
         this.var_1088 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_691);
         _loc1_.push(RoomWidgetUserActionMessage.const_493);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_470);
         _loc1_.push(RoomWidgetUserActionMessage.const_408);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_481);
         _loc1_.push(RoomWidgetUserActionMessage.const_718);
         _loc1_.push(RoomWidgetFurniActionMessage.const_289);
         _loc1_.push(RoomWidgetFurniActionMessage.const_695);
         _loc1_.push(RoomWidgetFurniActionMessage.const_707);
         _loc1_.push(RoomWidgetFurniActionMessage.const_872);
         _loc1_.push(RoomWidgetFurniActionMessage.const_941);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_981);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_980);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_936);
         _loc1_.push(RoomWidgetUserActionMessage.const_591);
         _loc1_.push(RoomWidgetUserActionMessage.const_635);
         _loc1_.push(RoomWidgetUserActionMessage.const_625);
         _loc1_.push(RoomWidgetUserActionMessage.const_1579);
         _loc1_.push(RoomWidgetPetCommandMessage.const_511);
         _loc1_.push(RoomWidgetPetCommandMessage.const_894);
         _loc1_.push(RoomWidgetUserActionMessage.const_555);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_591)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_409 || param1.type == RoomWidgetUserActionMessage.const_555 || param1.type == RoomWidgetUserActionMessage.const_625)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectMessage.const_691:
               return this.handleGetObjectNameMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_493:
            ...
            case RoomWidgetUserActionMessage.const_559:
               ...
               break;
            case RoomWidgetUserActionMessage.const_555:
               this._container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_521:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_807,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_517:
               ...
               break;
            case RoomWidgetUserActionMessage.const_470:
               this._container.sessionDataManager.unignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_408:
            ...
            case RoomWidgetUserActionMessage.const_560:
               ...
               break;
            case RoomWidgetUserActionMessage.const_481:
            ...
            case RoomWidgetFurniActionMessage.const_707:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_872:
               this._container.roomEngine.useRoomObjectInActiveRoom(_loc5_,_loc6_);
               break;
            case RoomWidgetFurniActionMessage.const_941:
            ...
            case RoomWidgetUserActionMessage.const_409:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_981:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_980:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_936:
            ...
            case RoomWidgetUserActionMessage.const_591:
               ...
               break;
            case RoomWidgetUserActionMessage.const_635:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_299);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_329);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_348) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_348);
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_299);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1261);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1089);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_613)
                  {
                     _loc30_ = this.var_226.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_426) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_426.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_226.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_209)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_158)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_632)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_638);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_110)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_784);
                  ...
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_752;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1566);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_620.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_620.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_784);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_226 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_226.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_399,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_226 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_422,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
