package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      private var var_1755:BitmapData;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_746,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_868,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_581,this.onHelpTutorialEvent);
         ...
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_746,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_868,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_581,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1427)
            {
               ...
               this.var_1427 = _loc3_;
               this.var_1756 = _loc1_;
               this.var_1755 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1756;
               _loc2_ = this.var_1755;
            }
         }
         if(this._toolbar != null)
         {
            _loc6_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1323,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_456)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_456,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_456 - const_1022)
                  {
                     _loc8_.offset(0,_loc2_.height - const_456 + const_1022);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_929);
         _loc1_.push(RoomWidgetDanceMessage.const_708);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_953);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_887);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_815);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_729);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_738);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_436);
         _loc1_.push(RoomWidgetStopEffectMessage.const_757);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1706);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1206);
         _loc1_.push(RoomWidgetToolbarMessage.const_710);
         _loc1_.push(RoomWidgetToolbarMessage.const_703);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_406);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1582);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1226);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_779);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_747);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_706);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1715);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_890);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_870);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_949);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_747:
               ...
               break;
            case RoomWidgetWaveMessage.const_929:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_708:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_953:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_887:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_815:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_436:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1091)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_227,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_738:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1152:
                        this._catalog.openCatalogPage(CatalogPageName.const_1807,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1225:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_326);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1761:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_81);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1607:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_729:
            case RoomWidgetStopEffectMessage.const_757:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1206:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_779:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_710:
               ...
               break;
            case RoomWidgetToolbarMessage.const_703:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_482,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_406:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_608));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_706:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_423,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_890:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_423,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_870:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_423,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_949:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_428:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_771));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_841));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_127:
               ...
               break;
            case HabboHelpTutorialEvent.const_581:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_628));
         }
      }
