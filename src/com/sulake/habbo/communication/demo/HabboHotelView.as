package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1102:Function;
      
      private var var_1103:Function;
      
      private var var_717:IAssetLibrary;
      
      private var var_1101:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_717 = param2;
         this._events = param3;
         this.var_820 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_717.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_717.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_29)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_589));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this.var_1103 != null)
            {
               this.var_1103(_loc4_);
               this.var_1103 = null;
            }
         }
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_717.loadAssetFromFile("hotel_view_banner_" + this.var_1101,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_830));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_820.addChildAt(this._window,0);
         }
      }
