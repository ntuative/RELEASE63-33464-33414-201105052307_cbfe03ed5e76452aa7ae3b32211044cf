package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_566:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_167.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_150,HabboWindowStyle.const_44,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1904,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1904,"/");
         ...
         {
            dispatchEvent(new Event(const_566));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_141.removeEventListener(SSOTicket.const_398,this.onParsedTicketSuccess);
            this.var_141.removeEventListener(SSOTicket.const_358,this.onParsedTicketFailure);
            this.var_141 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_141 = new SSOTicket(this.var_167.assets,_loc3_,_loc2_,param1);
         this.var_141.addEventListener(SSOTicket.const_398,this.onParsedTicketSuccess);
         this.var_141.addEventListener(SSOTicket.const_358,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_141.ticket);
         Logger.log("Has Facebook: " + this.var_141.isFacebookUser);
         if(this.var_141.isFacebookUser)
         {
            this.var_167.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_167.flashClientUrl = this.var_141.flashClientUrl;
         this.var_167.ssoTicket = this.var_141.ticket;
         this.var_141.removeEventListener(SSOTicket.const_398,this.onParsedTicketSuccess);
         this.var_141.removeEventListener(SSOTicket.const_358,this.onParsedTicketFailure);
         this.var_141 = null;
         dispatchEvent(new Event(const_566));
