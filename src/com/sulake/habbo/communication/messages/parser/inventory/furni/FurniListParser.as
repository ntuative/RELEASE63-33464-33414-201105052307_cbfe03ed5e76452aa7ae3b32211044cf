package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_2945:String;
      
      protected var var_2944:int;
      
      protected var var_2946:int;
      
      protected var var_1630:Array;
      ...
      {
         this.var_2945 = param1.readString();
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1630.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
