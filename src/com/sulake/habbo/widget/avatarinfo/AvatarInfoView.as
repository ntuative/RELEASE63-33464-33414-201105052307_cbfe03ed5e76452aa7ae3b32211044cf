package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1502:int = 25;
      ...
      protected var var_1634:int;
      
      protected var var_2557:Boolean;
      
      protected var var_2308:int;
      
      protected var var_1354:Boolean;
      
      protected var var_2163:FixedSizeStack;
      
      protected var var_2162:int = -1000000;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2163 = new FixedSizeStack(const_1502);
         super();
         this._widget = param1;
      }
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1634 = param5;
         param1.var_2308 = param4;
         param1.var_2557 = param6;
         param1.updateWindow();
      }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_873));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1354)
         {
            ...
            if(this.var_1634 == RoomObjectTypeEnum.const_158 || this.var_1634 == RoomObjectTypeEnum.const_632)
            {
            ...
            this.var_2163.addValue(_loc5_);
            _loc6_ = this.var_2163.getMax();
            if(_loc6_ < this.var_2162 - const_1070)
            {
               _loc6_ = this.var_2162 - const_1070;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2162 = _loc6_;
