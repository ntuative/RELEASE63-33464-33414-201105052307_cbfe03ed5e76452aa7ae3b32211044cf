package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private var var_2964:int = 500;
      
      private var var_302:AvatarInfoData;
      ...
      public function AvatarInfoWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboConfigurationManager, param4:IHabboLocalizationManager, param5:Component)
      {
         ...
         this.var_1428 = false;
         this.var_941 = false;
         this.var_1152 = new Timer(this.var_2962,1);
         this.var_1152.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
         this.var_302 = new AvatarInfoData();
         this.var_2365 = Boolean(this.var_183.getBoolean("menu.avatar.enabled",false));
         this.var_1763 = Boolean(this.var_183.getBoolean("hover.name.enabled",false));
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_693,0,0));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_329,this.updateEventHandler);
         ...
         if(this.var_1763)
         {
            param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_783,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_329,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_128:
               ...
               this.updateView(_loc2_.userId,_loc2_.userName,_loc2_.roomIndex,RoomObjectTypeEnum.const_158,_loc2_.allowNameChange,null);
               this.var_194 = true;
               break;
            case RoomWidgetRoomObjectNameEvent.const_593:
               ...
               {
                  this.updateView(RoomWidgetRoomObjectNameEvent(param1).userId,RoomWidgetRoomObjectNameEvent(param1).userName,RoomWidgetRoomObjectNameEvent(param1).roomIndex,RoomObjectTypeEnum.const_158,false,null);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_114:
            case RoomWidgetFurniInfoUpdateEvent.const_329:
               this.removeView();
               break;
            case RoomWidgetUserInfoUpdateEvent.const_126:
               this.getOwnCharacterInfo();
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_783:
               if(!(this._view is AvatarMenuView))
               {
                  this.var_1764 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_691,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_391:
               if(!(this._view is AvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1764)
                  {
                     this.removeView();
                     this.var_1764 = -1;
                  }
            ...
            case RoomWidgetUserInfoUpdateEvent.const_110:
               ...
               this.var_302.amIAnyRoomController = _loc3_.amIAnyRoomController;
               this.var_302.amIController = _loc3_.amIController;
               this.var_302.amIOwner = _loc3_.amIOwner;
               this.var_302.canBeAskedAsFriend = _loc3_.canBeAskedAsFriend;
               this.var_302.canBeKicked = _loc3_.canBeKicked;
               this.var_302.canTrade = _loc3_.canTrade;
               this.var_302.canTradeReason = _loc3_.canTradeReason;
               this.var_302.hasFlatControl = _loc3_.hasFlatControl;
               this.var_302.isIgnored = _loc3_.isIgnored;
               this.var_302.respectLeft = _loc3_.respectLeft;
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_158,false,!!_loc3_.isSpectatorMode ? null : this.var_302);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_632,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.PET_INFO:
               _loc5_ = param1 as RoomWidgetPetInfoUpdateEvent;
               this.updateView(_loc5_.id,_loc5_.name,_loc5_.roomIndex,RoomObjectTypeEnum.const_209,false,null);
               break;
      ...
      {
         this.var_941 = false;
         if(this.var_1152.running)
         {
            this.var_1152.stop();
         }
         var _loc7_:Boolean = param6 != null && this.var_2365;
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_941)
         {
            ...
            this._blend = 1 - this.var_1429 / Number(this.var_2964);
         }
         else
         {
            this._blend = 1;
