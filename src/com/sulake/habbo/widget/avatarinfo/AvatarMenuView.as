package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1324:uint = 0;
      
      protected static const const_369:uint = 1;
      
      protected static const const_987:uint = 2;
      
      protected static var var_1359:uint = const_369;
      
      private static const const_1372:uint = 4281149991;
      
      private static const const_1375:uint = 4283715916;
      
      private static const const_1374:uint = 16777215;
      
      private static const const_1376:uint = 9552639;
      
      private static const const_1371:uint = 16744755;
      
      private static const const_1373:uint = 16756591;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_333:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1340)
         {
            ...
            {
               this.var_333 = const_987;
            }
            else
            {
               this.var_333 = var_1359;
            }
         }
         if(this.var_333 == const_1324)
         {
         ...
         if(this.var_333 == const_1324 || this.var_333 == const_369)
         {
            ...
            else
            {
               ...
               this.var_333 = const_369;
            }
         }
         if(this.var_333 == const_369)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1373;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == "button")
            {
               param2.color = const_1372;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1374;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1371;
               }
            }
         }
         if(_loc3_)
