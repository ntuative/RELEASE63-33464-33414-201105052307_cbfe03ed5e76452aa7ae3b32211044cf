package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1071:int = 3;
      
      public static const const_520:int = 2;
      ...
      private static const const_1040:int = 150;
      
      private static const const_1041:int = 250;
      ...
      private var var_2526:BitmapData;
      
      private var var_1822:BitmapData;
      
      private var var_2527:BitmapData;
      
      private var var_1823:BitmapData;
      
      private var var_1821:BitmapData;
      
      private var var_2525:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_41 = param3;
         this.var_2526 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1822 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2527 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1823 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1821 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2525 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2529 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_72 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_340,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param3.width,param3.height - const_86),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_72);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_75,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_41.height - const_86,param3.width,const_86),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_541,HabboWindowStyle.const_44,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_86),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_520:
               this.var_72.blend += param1 / const_1041;
               this._window.blend += param1 / const_1041;
               if(this._window.blend >= 1)
               {
                  this.state = const_430;
               }
               break;
            case const_1071:
               this.var_72.blend -= param1 / const_1040;
               this._window.blend -= param1 / const_1040;
      ...
      public function set state(param1:int) : void
      {
         ...
         switch(param1)
         {
            case const_430:
               ...
               {
                  this.state = const_520;
               }
               else
               {
                  if(this._window == null || this.var_72 == null)
                  {
                     return;
                  }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_41.width - this.var_2530;
         }
         if(this.var_72 != null)
         {
            this.var_72.rectangle = this.var_41.rectangle;
            this.var_72.height -= const_86;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2528 == this._window.width)
         {
            return;
         }
         this.var_2528 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2527;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1823;
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2526,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1822,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1822,destGripRBitmap);
         ...
         this.var_72.bitmap = this.var_2529;
         this.var_72.disposesBitmap = false;
      }
