package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_949));
         }
         this._widget = null;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this._widget.config.getKey("client.toolbar.static.enabled","false") == "true")
         {
            this._widget.mainContainer.position = DEFAULT_LOCATION;
         }
         this._window.addEventListener(WindowEvent.const_142,this.onChildResized);
         this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_406,this._window));
      }
