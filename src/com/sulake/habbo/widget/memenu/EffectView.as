package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2139:int = 1000;
      ...
      private var var_745:ITextWindow;
      ...
      {
         super();
         this.var_200 = new Timer(this.const_2139);
         this.var_200.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_200.stop();
            this.var_200.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_200 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_177.isActive)
         {
            _loc2_ = this.var_177.secondsLeft / Number(this.var_177.duration);
            this.var_927.width = _loc2_ * this.var_321;
         }
         else
         {
            this.var_927.width = 0;
            this.var_200.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_745 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_745 == null)
            {
               return;
            }
         ...
         if(!this.var_177.isActive)
         {
            this.var_745.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_745.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_745.text;
         var _loc2_:int = this.var_177.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_177.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_177.isActive)
         {
         ...
         else
         {
            ...
            this.var_928 = this._window.findChildByName("effect_hilite");
            this.var_928.visible = false;
         }
         this.setTimeLeft();
         this.var_927 = this._window.findChildByName("loader_bar");
         if(this.var_927 != null)
         {
            this.var_321 = this.var_927.width;
            this.var_200.start();
            this.onUpdate();
         }
         if(this.var_177.icon)
         {
            this.setElementBitmap("effect_icon",this.var_177.icon);
         }
      }
