package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2980:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2980 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_403:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_57,this.var_139,this.var_2687++,this,this._questEngine);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               if(this.var_139.getKey("new.chat.widget.enabled") == "1")
               {
                  _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_57,this.var_139,this);
               }
               else
               {
                  _loc2_ = new RoomChatInputWidgetOld(this._windowManager,assets,this.var_57,this.var_139,this);
               }
               break;
            case RoomWidgetEnum.const_573:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_57,this.var_139,this._catalog);
               break;
            case RoomWidgetEnum.const_478:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_57,events,this.var_139);
               break;
            ...
            case RoomWidgetEnum.const_475:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_57,this.var_139,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_510:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_57,this.var_139);
               break;
            case RoomWidgetEnum.const_892:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_57,this.var_139);
               break;
            case RoomWidgetEnum.const_134:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_57,this.var_139);
               break;
            ...
            case RoomWidgetEnum.const_128:
               _loc2_ = new AvatarInfoWidget(this._windowManager,assets,this.var_139,this.var_57,this);
               break;
            ...
            case RoomWidgetEnum.const_496:
               _loc2_ = new PlayListEditorWidget(this._windowManager,this._soundManager,assets,this.var_57,this.var_139,this._catalog);
               break;
