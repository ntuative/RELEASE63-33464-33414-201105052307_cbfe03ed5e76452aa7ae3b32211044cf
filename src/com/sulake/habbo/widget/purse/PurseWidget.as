package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_1887:int = 3;
      
      private const const_2176:uint = 4.291993382E9;
      
      private const const_2174:uint = 4.29080704E9;
      
      private const const_2175:uint = 4.285767869E9;
      
      private const const_2173:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1887;
            this._view.y = this.const_1887;
      ...
      {
         this.var_1963 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1963.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1963.toString();
         }
      }
      ...
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1962.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1962.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1109));
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1275));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2174;
      }
      ...
      {
         param1.window.color = this.const_2173;
      }
