package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_947:String = "PLSV_ADD_SONGS";
      
      public static const const_1184:String = "PLSV_START_PLAYBACK";
      
      public static const const_602:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_43 != const_602)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_413[this.var_43];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_413[const_947];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_413.add(const_602,_loc1_);
