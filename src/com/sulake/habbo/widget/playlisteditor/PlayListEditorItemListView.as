   ...
   public class PlayListEditorItemListView
   {
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_498);
            }
            return;
         }
         ...
         if(this.var_1153 >= 0 && this.var_1153 < this._items.length)
         {
            _loc2_ = this._items[this.var_1153] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_498);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1221);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_remove_from_playlist" || _loc3_)
            {
               ...
               if(this.var_942 > -1)
               {
                  this._widget.sendRemoveFromPlayListMessage(this.var_942);
               }
               this.var_98 = null;
               this.var_942 = -1;
            }
