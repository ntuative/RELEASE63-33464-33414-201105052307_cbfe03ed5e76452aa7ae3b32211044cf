package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridItem
   {
      ...
      private static const const_1378:uint = 14612159;
      ...
      private var var_2287:IContainerButtonWindow = null;
      ...
      public function get method_15() : IContainerButtonWindow
      {
      ...
      private function createWindow() : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_2287 = _loc2_.getChildByName("button_to_playlist") as IContainerButtonWindow;
         }
         ...
         this.playButtonState = const_571;
      }
