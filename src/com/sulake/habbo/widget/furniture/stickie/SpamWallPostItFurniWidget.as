package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2165 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_590,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_590,this.onEditPostItRequest);
      }
      ...
      private function onEditPostItRequest(param1:RoomWidgetSpamWallPostItEditEvent) : void
      {
         ...
         this.var_459 = param1.location;
         var _loc2_:* = null;
         if(this._inventory != null)
         {
            _loc2_ = this._inventory.getItemById(FurniModel.const_49,var_195);
         }
         if(_loc2_ != null && this._roomEngine != null)
         {
            _loc3_ = this._roomEngine.getWallItemType(_loc2_.type);
            var_880 = !!_loc3_.match("vd") ? "post_it_vd" : "post_it";
         }
         else
         {
            var_880 = "post_it";
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_195 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_938,var_195,this.var_459,_text,var_336);
