package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1895:int = 0;
      
      private const const_1896:int = 1;
      
      private const const_1892:int = 2;
      
      private const const_1893:int = 3;
      
      private const const_1891:int = 4;
      
      private const const_2177:int = 0;
      
      private const const_2181:int = 1;
      
      private const const_2178:int = 2;
      
      private const const_2180:int = 3;
      
      private const const_2184:int = 4;
      
      private const const_2179:int = 5;
      
      private const const_1894:String = "deco_img";
      
      private const const_1890:String = "dialog_bg";
      
      private const const_2182:String = "%campaign%_dialog_bg.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1569 = this.var_139.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1569 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1570.length)
         {
            _loc2_ = this.var_1570.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_139 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_484,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_732,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_775,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_484,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_484:
               _loc2_ = this.const_1895;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_775:
               ...
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     _loc2_ = this.const_1893;
                     var_57.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
                     _loc2_ = this.const_1892;
                  }
               }
               else
               {
                  _loc2_ = this.const_1891;
               }
               this._shareId = null;
               this.var_1571 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_732:
               _loc2_ = this.const_1896;
         ...
         if(this._window && (this.var_1572 != _loc2_ || _loc3_ != this.var_187))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1572)
            {
               ...
               case this.const_1896:
                  if(this.var_406 == this.const_2177)
                  {
                  ...
                  else if(this.var_406 == this.const_2178)
                  {
                  ...
                  else if(this.var_406 == this.const_2179)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2182.replace("%campaign%",this.var_187);
            this.setDecoImage(_loc5_,this.const_1890);
            _loc2_ = _loc2_.replace("%campaign%",this.var_187);
            this.setDecoImage(_loc2_,this.const_1894);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_915);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_139.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_178);
            _loc2_.objectId = this.var_195;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
         if(this._inventory)
         {
            if(this.var_1571 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1571 == 1 ? "null" : InventoryCategory.const_146);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_846,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1570.push(new ImageDownloader(this,_assets,this.var_187,this.var_1569,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_1890:
