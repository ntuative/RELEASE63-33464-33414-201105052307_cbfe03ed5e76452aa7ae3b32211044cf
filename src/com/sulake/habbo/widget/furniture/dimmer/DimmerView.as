package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_612:DimmerViewColorGrid;
      
      private var var_431:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_75,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1411,const_1410,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_612 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_431 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1437 = _loc2_.light;
         if(this.var_431 != null)
         {
            this.var_431.setValue(this.var_1437);
         }
         this.var_516 = this.colors.indexOf(_loc2_.color);
         if(this.var_612 != null)
         {
            this.var_612.setSelectedColorIndex(this.var_516);
         }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_274.selector.method_1();
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1438 = XML(_loc1_.content);
         return this.var_1438;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_431 != null)
         {
            this.var_431.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_612 != null)
         {
            this.var_612.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
