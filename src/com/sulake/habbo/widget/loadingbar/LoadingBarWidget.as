package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_502:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_502.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_502 = null;
         }
         if(this.var_45 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_502 == null)
         {
            this.var_502 = new Sprite();
            this.var_502.addChild(new Bitmap(this.var_45));
            this.var_502.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_502.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_45;
            }
         }
         _loc2_.setDisplayObject(this.var_502);
