package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_1950:IWindow;
      
      private var _button:IWindow;
      
      private var var_1949:IWindow;
      
      private var var_1551:IWindow;
      ...
      private const const_2165:String = "${widgets.chatinput.say}";
      
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1125 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         ...
         this.var_423 = new Timer(10000,1);
         this.var_423.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_423.reset();
            this.var_423.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_423 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1950 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1949 = this._window.findChildByName("send_button_text");
         this.var_1551 = this._window.findChildByName("block_text");
         this.var_1949.caption = this.const_2165;
         this.var_24.setParamFlag(HabboWindowParam.const_39,true);
         this.var_24.addEventListener(WindowMouseEvent.const_42,this.windowMouseEventProcessor);
         this.var_24.addEventListener(WindowKeyboardEvent.const_174,this.windowKeyEventProcessor);
         this.var_24.addEventListener(WindowKeyboardEvent.const_360,this.keyUpHandler);
         ...
         this.var_1552 = true;
         this.var_495 = "";
         this._window.addEventListener(WindowEvent.const_733,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_624,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1950.width) / 2 - _loc3_;
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_24 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1125 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_24.text = "";
                  this.var_495 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_495.length + 1)
            {
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_115);
