package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_95:IWindowContainer;
      
      private var var_46:IBorderWindow;
      
      private var var_1262:TagListRenderer;
      
      private var var_135:IBorderWindow;
      
      private var var_2711:int;
      
      private var var_2710:Boolean = true;
      
      private const const_1067:int = 5;
      
      private const const_1885:int = 7829367;
      
      private const const_1886:int = 16777215;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1262 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2710 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:* = [];
         this.var_95.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_135.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_135.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_135.x = _loc5_.left - this.var_135.width;
         this.var_135.y = _loc5_.top + (_loc5_.height - this.var_135.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_135.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_135.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_135.x = _loc7_.left - this.var_135.width;
         this.var_135.y = _loc7_.top + (_loc7_.height - this.var_135.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_135 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_135 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1067;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1885;
            }
            else
            {
               _loc3_.textColor = this.const_1886;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1067,this.const_2166);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_360,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_360,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1262.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_95.getChildByName(param1) as IRegionWindow;
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_727:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_752:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2711 > this.const_2167 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2711 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1885;
         }
      }
