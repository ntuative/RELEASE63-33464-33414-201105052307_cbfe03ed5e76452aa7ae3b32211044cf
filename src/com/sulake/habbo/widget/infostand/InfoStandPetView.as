package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2155:int = 152;
      
      private const const_2147:int = 16;
      
      private const const_1454:int = 4;
      
      private const const_2154:uint = 14342874;
      
      private const const_2157:uint = 3815994;
      
      private const const_2152:uint = 2085362;
      
      private const const_2146:uint = 39616;
      
      private const const_2149:uint = 10513106;
      
      private const const_2148:uint = 8734654;
      
      private const const_2150:uint = 9094430;
      
      private const const_2156:uint = 6200576;
      
      private const const_2151:String = "happiness";
      
      private const const_2158:String = "experience";
      
      private const const_2153:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2151,param1.nutrition,param1.nutritionMax,this.const_2146,this.const_2152);
         this.updateStateElement(this.const_2158,param1.experience,param1.experienceMax,this.const_2148,this.const_2149);
         this.updateStateElement(this.const_2153,param1.energy,param1.energyMax,this.const_2156,this.const_2150);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2155,this.const_2147,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2154);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2157);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1454,_loc7_.width - 2,_loc7_.height - 2 - this.const_1454);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1454);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_206 && this.var_206.getPetId() == this.var_538)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_408,this._widget.petData.ownerId);
