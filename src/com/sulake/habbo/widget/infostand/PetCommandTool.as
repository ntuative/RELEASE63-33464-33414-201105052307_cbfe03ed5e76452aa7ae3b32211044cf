package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_450:IFrameWindow;
      ...
      private const const_2172:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_383 = new Timer(this.const_2172);
         this.var_383.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1270.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1270.getValue(this.var_538) as CommandConfiguration;
      ...
      {
         this.var_1270.remove(param1);
         this.var_1270.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_894,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40.setParamFlag(WindowParam.const_106,true);
         this.var_40.context.getDesktopWindow().addEventListener(WindowEvent.const_41,this.onWindowDesktopResized);
         this.var_40.procedure = this.onCommandWindowProcedure;
         this.var_40.position = DEFAULT_LOCATION;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_450 == null)
         {
            ...
            this.var_450 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_450 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_450.x = 200;
            this.var_450.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_409,this.var_538));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_511,this.var_538,this.var_1961 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_511,this.var_538,this.var_1961 + " " + _loc5_);
