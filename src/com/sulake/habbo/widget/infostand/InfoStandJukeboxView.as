package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         if(var_46 != null)
         {
            var_52 = var_46.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         ...
         var_241 = var_46.findChildByTag("catalog");
         if(var_241 != null)
         {
            var_241.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
      ...
      {
         var _loc2_:IWindowContainer = var_52.getListItemByName("trackname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_52.getListItemByName("creatorname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_399)
         {
            this.var_1638 = param1.songId;
         }
         if(param1.songId == this.var_1638)
         {
            this._songName = param1.songName;
            this.var_2237 = param1.songAuthor;
            this.updateNowPlaying(this.var_1638 >= 0);
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:ITextWindow = var_52.getListItemByName("now_playing_text") as ITextWindow;
         if(_loc2_ != null)
         {
            if(param1)
            {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2237;
         }
         else
         {
