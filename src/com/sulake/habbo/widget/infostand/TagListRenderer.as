package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2140:int = 5;
      
      private const const_2141:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_149:Function;
      
      private var _offsetX:int;
      
      private var var_1147:int;
      
      private var var_1148:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1147 = 0;
         this.var_1148 = param2.rectangle.clone();
         this.var_1148.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1148.width)
         {
            return false;
         }
         if(this.var_1147 + param1.height > this.var_1148.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1148.width)
         {
            this._offsetX = 0;
            this.var_1147 += param1.height + this.const_2141;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1147);
         this._offsetX += param1.width + this.const_2140;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1478 != null && this.var_1478.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_149);
