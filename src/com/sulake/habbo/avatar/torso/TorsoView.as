   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_292,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_208,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_251,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_66 && var_145 == "")
         {
            var_66.switchCategory(FigureData.const_208);
         }
      }
