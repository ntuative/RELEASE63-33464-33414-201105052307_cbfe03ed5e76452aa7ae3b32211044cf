package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class PartColor implements IPartColor
   {
      ...
      public function PartColor(param1:XML)
      {
         ...
         this.var_2258 = parseInt(param1.@club);
         this.var_2199 = Boolean(parseInt(param1.@selectable));
         ...
         this.var_744 = new ColorTransform(this.var_2093,this.var_2094,this.var_2092);
      }
