   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_225,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_243,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_259,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_286,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_262,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_66 && var_145 == "")
         {
            var_66.switchCategory(FigureData.const_225);
         }
      }
