package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2192:String = "hd-99999-99999";
      ...
      private var var_330:PetDataManager;
      
      private var var_861:PaletteManager;
      
      private var var_333:String;
      
      private var var_329:Map;
      
      private var var_240:AvatarAssetDownloadManager;
      
      private var var_2088:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_333 = RenderMode.const_1727;
         this.var_329 = new Map();
         this.var_106 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_130,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_106.add(AvatarType.const_130,_loc4_);
         ...
         this.var_106.add(AvatarType.const_70,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_330 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_861 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_330.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_106.getValues())
            {
               _loc1_.dispose();
            }
         ...
         if(this.var_240)
         {
            this.var_240.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_330.init();
         this.var_861.init();
         _loc2_ = this.var_106.getValue(AvatarType.const_130) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_106.getValue(AvatarType.const_70) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_106.getValue(AvatarType.const_130) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_183.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_240 == null)
               {
                  ...
                  _loc6_ = this.var_183.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_183.getKey("flash.dynamic.avatar.download.url","");
                  this.var_240 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_240.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_938)
         {
            if(this.var_2891 && this.var_2889 && this.var_2890)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_240.isReady(param1);
      }
      
      public function method_12(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         if(!this.var_240)
         {
            return;
         }
         this.var_240.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_106.getValue(AvatarType.const_130) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_240.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2088)
         {
            this.var_2088 = new AvatarFigureContainer(this.const_2192);
         }
         this.var_240.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2088,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_329.getKeys())
         {
            _loc4_ = this.var_329.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_330.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         ...
         {
            _loc6_ = !this.var_330.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_330.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_106.getValue(AvatarType.const_70) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_329.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_330.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_106.getValue(AvatarType.const_70);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_329.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_329.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_106.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_106.getValue(AvatarType.const_130) as AvatarStructure;
      ...
      {
         return this.var_330 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_130:
               _loc3_ = this.var_106.getValue(AvatarType.const_130) as AvatarStructure;
               break;
            case AvatarType.const_70:
               _loc3_ = this.var_106.getValue(AvatarType.const_70) as AvatarStructure;
               break;
            default:
