package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_281:AvatarImageCache;
      
      private var var_647:int = 0;
      
      private var var_1672:int = 0;
      
      private var var_641:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_641 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_641.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1393 = this.var_1096;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1393);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_647);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_641,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1393 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_647);
                  _loc20_ = this.var_88;
                  _loc21_ = 1;
                  switch(this.var_88)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_647);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_641,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_93)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_647);
                  _loc21_ = this.var_88;
                  _loc22_ = 1;
                  switch(this.var_88)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_525 = this.var_525 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_427:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1632:
                  case AvatarAction.const_1557:
                  case AvatarAction.const_1266:
                  case AvatarAction.const_1192:
                  case AvatarAction.const_1757:
                  case AvatarAction.const_1685:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_903);
         this.getCache().resetBodyPartCache(this.var_903);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1391 = this._structure.sortActions(this.var_334);
         ...
         {
            this.var_767 = this._structure.getCanvasOffsets(this.var_1391,this._scale,this.var_88);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1391)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_367)
               {
                  this.var_904 = true;
               }
            }
