package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2547:uint;
      
      private var var_2548:uint;
      ...
      {
         super();
         this.var_1831 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2547 = parseInt(_loc2_,16);
         this.var_2548 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1641 = this._rgb >> 16 & 255;
         this.var_1640 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_2093 = this.var_1641 / 255 * 1;
         this.var_2094 = this.var_1640 / 255 * 1;
         this.var_2092 = this._b / 255 * 1;
         if(this.var_1831 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2549 = false;
         }
         this.var_744 = new ColorTransform(this.var_2093,this.var_2094,this.var_2092,this._alphaMultiplier);
         this.var_1190 = this.generatePaletteMapForGrayscale(this.var_2548,this.var_2547);
      }
      ...
      {
         return this.var_1190.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1190.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1190.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1190.getValue("alphas") as Array;
      }
