package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1332:IWindowContainer;
      
      public static var var_1626:IWindowContainer;
      
      public static var var_2114:int = 6710886;
      ...
      private var var_345:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_494:IFrameWindow;
      
      private var var_422:Timer;
      
      private var var_2270:Number = 0;
      
      private var var_2289:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1124 = [];
         this.var_1403 = [AvatarEditorFigureCategory.const_853,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_283,AvatarEditorFigureCategory.const_701,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_111];
         super();
         ...
         if(var_1332 == null)
         {
            ...
            var_1332 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1626 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1626 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_422 = new Timer(1000);
         this.var_422.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1403;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_422.stop();
            this.var_422.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_422 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1403);
         }
         if(param1.length != this.var_1124.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1124.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2289 = this.canChangeOutfit();
            this.var_422.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_345 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_345.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_345.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1124.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_345.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_345.numSelectables)
               {
                  this.var_345.getSelectableAt(_loc6_).x = this.var_345.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_345.setSelected(this.var_345.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1403;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1696 == AvatarEditorSideCategory.const_111 || this.var_2290))
         {
         ...
         this.setViewToCategory(this.var_350);
      }
      ...
      {
         if(this.var_1696 == AvatarEditorSideCategory.const_111)
         {
            this.var_2290 = false;
            this.setSideContent(AvatarEditorSideCategory.const_835);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_111);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_835:
               break;
            case AvatarEditorSideCategory.const_516:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_516);
               break;
            case AvatarEditorSideCategory.const_111:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_111);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_350 = param1;
         this.var_345.setSelected(this.var_345.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2270 = new Date().valueOf();
                  this.var_2289 = false;
                  this.var_422.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_494)
         {
            ...
            this.var_494 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_494.procedure = this.stripClubDialogEventProc;
            this.var_494.center();
         }
         else
         {
            this.var_494.visible = true;
            this.var_494.center();
         }
      }
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2270 > 5000;
      }
   }
}
