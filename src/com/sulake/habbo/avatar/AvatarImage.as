package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1364:String = "Default";
      
      private static const const_1365:int = 2;
      
      private static const const_1366:String = AvatarSetType.const_35;
      ...
      protected var var_1824:int;
      
      protected var var_287:IActiveActionData;
      
      protected var var_1088:Boolean;
      
      protected var var_767:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_281:AvatarImageCache;
      
      protected var var_641:AvatarFigureContainer;
      
      protected var var_575:IAvatarDataContainer;
      
      protected var var_334:Array;
      
      protected var var_45:BitmapData;
      
      private var var_903:IActiveActionData;
      ...
      protected var var_1349:Boolean = false;
      ...
      private var var_2646:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_641 = param3;
         this.var_281 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1366,const_1365);
         this.var_334 = new Array();
         this.var_903 = new ActiveActionData(AvatarAction.const_393);
         this.var_903.definition = this._structure.getActionDefinition(const_1364);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1088)
         {
            ...
            if(this.var_806)
            {
               for each(_loc2_ in this.var_806)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_641,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1672;
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_647,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_269.length == 1 && this.var_88 == this.var_1824)
         {
            return this.var_88 + this.var_525 + this.var_647 % 4;
         }
         if(this.var_269.length == 2)
         {
            for each(_loc1_ in this.var_269)
            {
               ...
               {
                  return this.var_88 + this.var_525 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_647 % 11;
                  return this.var_88 + "_" + this.var_1824 + this.var_525 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2645 || param2 != this.var_2646 || param1 != this.var_2644)
         {
            this.var_2645 = param3;
            this.var_2646 = param2;
            this.var_2644 = param1;
            this.var_1901 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_287.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1349 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1349)
            {
               this.var_45.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_287.definition.geometryType,this.var_88);
         this.var_45.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_647);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_287.definition.geometryType,this.var_88);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_647);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_334.push(new ActiveActionData(param1,param2,this.var_647));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_903;
         this.var_287.definition = this.var_903.definition;
         this.resetBodyPartCache(this.var_903);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_525 = "";
         this.var_269 = this._structure.sortActions(this.var_334);
         if(this.var_269 == null)
         {
            this.var_767 = new Array(0,0,0);
            if(this.var_1522 != "")
            {
               _loc1_ = true;
               this.var_1522 = "";
         ...
         {
            this.var_767 = this._structure.getCanvasOffsets(this.var_269,this._scale,this.var_88);
            for each(_loc4_ in this.var_269)
            {
               this.var_525 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_366)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1521 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1521 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1522 != this.var_525)
            {
               _loc1_ = true;
               this.var_1522 = this.var_525;
            }
         }
         this.var_1392 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_269)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_904 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_203 = this.var_203.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1672 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_367 || _loc1_.actionType == AvatarAction.const_258 || _loc1_.actionType == AvatarAction.const_448)
               {
                  this.var_904 = true;
               }
            }
