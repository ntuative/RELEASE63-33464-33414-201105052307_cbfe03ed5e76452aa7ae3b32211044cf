package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1786 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2440 = parseInt(param1.@precedence);
         this.var_2441 = String(param1.@activepartset);
         this.var_2436 = String(param1.@assetpartdefinition);
         this.var_2434 = String(param1.@lay);
         this.var_849 = String(param1.@geometrytype);
         this.var_2439 = Boolean(parseInt(param1.@main));
         this.var_2438 = Boolean(parseInt(param1.@name_6));
         this.var_2437 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2435 = _loc6_;
            }
            else
            {
               this.var_1786[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_767.add(param1,new Map());
         }
         var _loc4_:Map = this.var_767.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_767.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1786[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2435;
         }
         return _loc2_;
      }
