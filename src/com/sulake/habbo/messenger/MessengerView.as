package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1390:ConversationView;
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_15 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_142.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_57,HabboToolbarIconEnum.MESSENGER,this.var_15));
         }
         else
         {
            this.refresh();
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1390.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_15 = IFrameWindow(this.var_142.getXmlWindow("main_window"));
         ...
         this.var_901 = new ConversationsTabView(this.var_142,this.var_15);
         this.var_901.refresh();
         this.var_902 = ITextFieldWindow(this.var_15.findChildByName("message_input"));
         this.var_902.addEventListener(WindowKeyboardEvent.const_174,this.onMessageInput);
         this.var_1390 = new ConversationView(this.var_142,this.var_15);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_812,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1310,true);
         this.var_15.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc3_ = 120;
            _loc4_ = this.var_902.text;
            if(_loc4_.length > _loc3_)
            {
               this.var_902.text = _loc4_.substring(0,_loc3_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_902.text;
         ...
         this.var_902.text = "";
         this.var_142.conversations.addMessageAndUpdateView(new Message(Message.const_690,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
