package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1084:int = 100;
      
      private static const const_1537:int = 20;
       
      
      private var var_142:HabboMessenger;
      
      private var var_2883:IScrollbarWindow;
      
      private var var_2086:IContainerButtonWindow;
      
      private var _list:IItemListWindow;
      
      private var var_566:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_142 = param1;
         this.var_2086 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this._list = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2883 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_142.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1084 + const_1537)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_142.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1538;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_566 == null || _loc1_.id != this.var_566.id)
         {
            this.var_566 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_566.followingAllowed)
         {
            this.var_2086.enable();
         }
         else
         {
            this.var_2086.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this._list.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_566.messages.length - const_1084);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_566.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_566.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_142.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_690 || param3.type == Message.const_799 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_566.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_142.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_142.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_142.send(new FollowFriendMessageComposer(this.var_566.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_142.conversations.closeConversation();
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_739)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1287)
         {
            return 4288269465;
         }
         return 4291611852;
