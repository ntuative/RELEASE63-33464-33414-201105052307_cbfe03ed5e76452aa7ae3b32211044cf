package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_646:int = 70;
      ...
      private static const const_464:Number = 50;
      ...
      private var var_2738:Map;
      
      private var var_458:Map;
      
      private var var_1292:uint;
      
      private var var_1291:uint;
      
      private var var_1581:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_2011 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_2011 = 15;
         }
         this.var_2010 = this._window.height;
         this.var_832 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_520:
               ...
               _loc2_ = Number(this.var_1292) / Number(this.var_458["time_fade_in"]);
               if(this.var_1292 > int(this.var_458["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1072:
               ...
               if(this.var_1581 > int(this.var_458["time_display"]) && !this.var_2012)
               {
                  this.startFadeOut();
               }
               break;
            case const_1071:
               ...
               _loc3_ = 1 - Number(this.var_1291) / Number(this.var_458["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1291 > int(this.var_458["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2011;
         if(this._window.height < this.var_2010)
         {
            this._window.height = this.var_2010;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this._toolbar.orientation == "TOP" ? int(const_464) : 0;
         var _loc4_:int = this._toolbar.orientation == "BOTTOM" ? int(_loc2_.height - const_464) : int(_loc2_.height);
         var _loc5_:int = this._toolbar.orientation == "LEFT" ? int(const_464) : 0;
         var _loc6_:int = this._toolbar.orientation == "RIGHT" ? int(_loc2_.width - const_464) : int(_loc2_.width);
         if(this.var_458["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_582;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_582;
            }
         }
         else if(this.var_458["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_582;
         }
         else
         ...
         if(this.var_458["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_832;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_832;
            }
         }
         else if(this.var_458["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_832;
         }
         else
