package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1700 != "")
         {
            friendList.refreshText(param1,"name_text_online",this.var_805,this.var_1700);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",this.var_805,this.var_1896);
         }
         friendList.refreshText(param1,"name_text_offline",!this.var_805,this.var_1896);
         friendList.refreshText(param1,"motto_text",this.var_805,this.var_2207);
         friendList.refreshButton(param1,"offline",!this.var_805,null,0);
         if(this.var_805)
         {
            this.refreshFigure(param1,this.var_2209);
