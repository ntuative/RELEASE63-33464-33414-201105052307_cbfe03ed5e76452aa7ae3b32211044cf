package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1942:int = "F".charCodeAt(0);
      
      public static const const_1929:int = "M".charCodeAt(0);
      ...
      private var var_1194:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_993 = param1.gender;
         this.var_805 = param1.online;
         this.var_1838 = param1.followingAllowed && param1.online;
         this.var_641 = param1.figure;
         this.var_1703 = param1.motto;
         this.var_1701 = param1.lastAccess;
         this.var_1568 = param1.categoryId;
         this.var_1700 = param1.realName;
