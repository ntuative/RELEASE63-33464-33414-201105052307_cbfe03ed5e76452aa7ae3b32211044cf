package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1864:String = "noconvinfo";
      
      private static const const_1865:String = "messageinput";
      ...
      private var var_1418:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList, param2:IHabboConfigurationManager)
      {
         ...
         this.var_1418 = new FriendListTabsView(this._friendList);
      ...
      private function prepare() : void
      {
         ...
         this.var_1059 = IWindowContainer(this.var_15.content.findChildByName("main_content"));
         this.var_245 = IWindowContainer(this.var_15.content.findChildByName("footer"));
         this.var_1418.prepare(this.var_1059);
         this.var_15.procedure = this.onWindow;
         this.var_15.content.setParamFlag(HabboWindowParam.const_1121,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_1140,true);
         this.var_15.header.setParamFlag(HabboWindowParam.const_885,false);
         this.var_15.header.setParamFlag(HabboWindowParam.const_975,true);
         this.var_15.content.setParamFlag(HabboWindowParam.const_885,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_975,true);
         this.var_15.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1417 = ITextWindow(this.var_15.findChildByName("info_text"));
         this.var_1417.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1734 == -1 ? 0 : int(this.var_15.height - this.var_1734);
         var _loc4_:int = this.var_1732 == -1 ? 0 : int(this.var_15.width - this.var_1732);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_245.y = Util.getLowestPoint(this.var_15.content);
         this.var_245.width = this._friendList.tabs.windowWidth;
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1310,this._friendList.tabs.findSelectedTab() != null);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_885,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1121,false);
         ...
         this.var_1734 = this.var_15.height;
         this.var_1732 = this.var_15.width;
