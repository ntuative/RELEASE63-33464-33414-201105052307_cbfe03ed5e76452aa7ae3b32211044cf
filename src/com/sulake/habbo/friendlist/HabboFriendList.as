package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_142:IHabboMessenger;
      ...
      private var var_809:ISessionDataManager;
      
      private var var_2676:FriendListLookAndFeel;
      
      private var var_434:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1920:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_652.stop();
            this.var_652.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_652 = null;
         }
         ...
         if(this.var_142)
         {
            this.var_142.release(new IIDHabboMessenger());
            this.var_142 = null;
         }
         if(this.var_183)
         {
         ...
         if(this.var_1136)
         {
            this.var_1136.release(new IIDAvatarRenderManager());
            this.var_1136 = null;
         }
         if(this.var_1018)
         {
         ...
         if(this.var_809)
         {
            this.var_809.release(new IIDSessionDataManager());
            this.var_809 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1920 = new OpenedToWebPopup(this);
         }
         this.var_1920.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_107);
      }
      
      public function openFriendRequests() : void
      {
         this.openFriendListWithTab(FriendListTab.const_97);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_364);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_105,HabboToolbarIconEnum.FRIENDLIST);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_340,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1136.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_183.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_183.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_142 = param2 as IHabboMessenger;
      ...
      {
         this.var_1018 = param2 as IHabboNotifications;
      ...
      {
         this.var_809 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this._view = new FriendListView(this,this.var_183);
         ...
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_1119,this.getText("friendlist.friends")));
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_392,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_100.addFriend(new Friend(_loc4_));
         }
         this.var_434 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_652)
         {
            this.var_652 = new Timer(120000);
            this.var_652.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_652.start();
         }
         this.getBuddyRequests();
         this.method_9();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_100.findCategory(FriendCategory.const_392);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_434.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_395));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_107:
                     this.trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_364:
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_434.findTab(FriendListTab.const_97).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_434.findTab(FriendListTab.const_97);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1921.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_434.findTab(FriendListTab.const_97);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_809 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_809.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_809.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_171) as IBitmapWrapperWindow;
