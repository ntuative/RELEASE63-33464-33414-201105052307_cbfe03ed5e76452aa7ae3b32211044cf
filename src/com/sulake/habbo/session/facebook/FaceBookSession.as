package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1062:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1481:String = "sendAccessTokenToServer";
      
      private static const const_1480:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1481,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1480,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1062);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1062);
         }
      }
