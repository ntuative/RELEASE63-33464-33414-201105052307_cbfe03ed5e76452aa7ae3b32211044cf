package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_770:IssueMessageData = null;
      
      private var var_769:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2452 = param2.pickerUserId;
         this.var_2467 = param2.pickerUserName;
         this.var_1459 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1166 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1165;
         }
         if(this.var_770 == null || param1.timeStamp < this.var_770.timeStamp)
         {
            this.var_770 = param1;
         }
         if(this.var_769 == null || param1.priority > this.var_769.timeStamp)
         {
            this.var_769 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1166 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1165;
            }
            if(this.var_770 == _loc2_)
            {
               this.var_770 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_769;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_770;
         if(_loc2_ == null)
         {
