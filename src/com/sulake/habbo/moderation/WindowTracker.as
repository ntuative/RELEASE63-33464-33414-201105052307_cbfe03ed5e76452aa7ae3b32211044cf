package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1671:int = 1;
      ...
      public static const const_1117:int = 5;
      
      public static const const_1647:int = 6;
      
      public static const const_1573:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1767:int = 9;
       
      
      private var var_1917:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1917 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1917[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1917[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
