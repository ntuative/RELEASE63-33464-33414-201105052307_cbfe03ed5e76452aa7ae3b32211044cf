package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_169:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_556:UserInfoCtrl;
      
      private var var_1315:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_169.getHighestPriorityIssue();
         this.var_556 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_1315 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_556.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_169.reportedUserId > 0)
         {
            this.var_1315.load(_loc4_,this.var_169.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_169.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_169.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_65 != null && this.var_65.issueManager != null && this.var_169 != null)
         {
            this.var_65.issueManager.removeHandler(this.var_169.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_169.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_169.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_169.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.releaseBundle(this.var_169.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_169.getHighestPriorityIssue().issueId;
         this.var_65.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_65,WindowTracker.const_1162,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_169.getHighestPriorityIssue();
            this.var_556 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
            this.var_556.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
