package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_991:Array = [];
      
      private static var var_1872:int = 200;
      ...
      {
         this.var_792 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1647;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_991.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_792.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_991.length < var_1872)
         {
            ...
            param1.width = this.var_792.width;
            param1.height = this.var_792.height;
            var_991.push(param1);
         }
         else
         {
