package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1002:int = 60;
      
      private static const const_999:int = 3600;
      
      private static const const_1000:int = 86400;
      
      private static const const_1001:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1002)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_999)
         {
            return Math.round(param1 / const_1002) + " mins ago";
         }
         if(param1 < 2 * const_1000)
         {
            return Math.round(param1 / const_999) + " hours ago";
         }
         if(param1 < 2 * const_1001)
         {
            return Math.round(param1 / const_1000) + " days ago";
         }
         return Math.round(param1 / const_1001) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1112.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_33.getXmlWindow("user_info"));
            this.var_1112.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_33,WindowTracker.const_1117,this._data.userId),this._callerFrame,this.var_1113,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new RoomVisitsCtrl(this.var_33,this._data.userId),this._callerFrame,this.var_1113,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new SendMsgsCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1377),this._callerFrame,this.var_1113,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ModActionCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1377),this._callerFrame,this.var_1113,false,true);
      }
