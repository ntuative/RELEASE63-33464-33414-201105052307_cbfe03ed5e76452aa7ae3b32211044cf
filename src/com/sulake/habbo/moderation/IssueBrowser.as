package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2170:String = "my_issues";
      
      private const const_2168:String = "open_issues";
      
      private const const_2169:String = "picked_issues";
      
      private const const_2195:String = "closed_issues";
      ...
      private var var_381:IIssueBrowserView;
      
      private var var_1954:IIssueBrowserView;
      
      private var var_1955:IIssueBrowserView;
      
      private var var_1956:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_381.view.width = this.var_274.container.width;
         this.var_381.view.height = this.var_274.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2170:
               if(this.var_1954 == null)
               {
                  this.var_1954 = new MyIssuesView(this.issueManager,this,this.var_274.container);
               }
               return this.var_1954;
            case this.const_2168:
               if(this.var_1955 == null)
               {
                  this.var_1955 = new OpenIssuesView(this.issueManager,this,this.var_274.container);
               }
               return this.var_1955;
            case this.const_2169:
               if(this.var_1956 == null)
               {
                  this.var_1956 = new PickedIssuesView(this.issueManager,this,this.var_274.container);
               }
