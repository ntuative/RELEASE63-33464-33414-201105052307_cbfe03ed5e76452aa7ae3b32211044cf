package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_365 == null || this.var_365.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this._window.center();
            _loc10_ = this._questEngine.controller.questsList.createListEntry();
            _loc10_.x = 8;
            _loc10_.y = 8;
         ...
         this._questEngine.controller.questsList.refreshEntryDetails(_loc10_,param1);
         ...
         var _loc6_:Boolean = this.var_365.type == "PLACE_ITEM" || this.var_365.type == "PLACE_FLOOR" || this.var_365.type == "PLACE_WALLPAPER";
         ...
         this._questEngine.controller.questsList.setEntryHeight(_loc10_);
