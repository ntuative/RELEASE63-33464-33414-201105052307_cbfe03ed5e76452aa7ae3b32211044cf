package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1401:int = 5;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_723 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_723.toggle();
         this.var_1742 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_577 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1401;
      ...
      private function refreshEntryQuestDetails(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         this._questEngine.setupRewardImage(param1,param2);
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1742 && !this.var_1741)
            {
               this.var_1742 = false;
