   ...
   public class CampaignCompleted implements IDisposable
   {
      ...
      public function show(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this._window.center();
            _loc3_ = this._questEngine.controller.questsList.createListEntry();
            _loc3_.x = 8;
            _loc3_.y = 8;
            this._window.content.addChild(_loc3_);
         }
         _loc3_ = IWindowContainer(this._window.findChildByName("entry_container"));
         this._questEngine.controller.questsList.refreshEntryDetails(_loc3_,param1);
         this._questEngine.controller.questsList.setEntryHeight(_loc3_);
