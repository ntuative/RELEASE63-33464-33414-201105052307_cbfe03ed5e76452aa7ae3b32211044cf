package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_439:IRoomSettingsCtrlOwner;
      ...
      private var var_971:TextFieldManager;
      
      private var var_1195:TextFieldManager;
      ...
      {
         this.var_367 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_367));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1840 = true;
         this.var_439.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_367 || this.var_1197 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1197 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1575)
         {
            this.var_783.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1783)
         {
            this.var_783.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1794)
         {
         ...
         {
            this.setTagError(this.var_910,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_911,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1739)
         {
            this.setTagError(this.var_910,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_911,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1574)
         {
            this.var_971.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_783.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_971.clearErrors();
         this.var_1195.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_315,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_535,this.onDoorModePasswordUnselect);
         this.getSaveButton().addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSaveButtonClick);
         this.method_7().addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCancelButtonClick);
         ...
         this.var_783 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1202 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_910 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_911 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_971 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1195 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1201 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1203 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1198 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         ...
         this.var_1196 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1200 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1839 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1470 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_260 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1199 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1471 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1471.mouseThreshold = 0;
         this.var_1471.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1199.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1839.visible = this._inRoom;
         if(this.var_782)
         {
            this.var_1200.visible = true;
            this.var_1470.visible = false;
            this.refreshFlatControllers();
            this.var_1200.height = Util.getLowestPoint(this.var_1200) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1196.visible = true;
            this.var_1470.visible = true;
            this._thumbnailContainer.visible = this._inRoom;
            this.var_1196.height = Util.getLowestPoint(this.var_1196) + 4;
         }
         this.var_1471.text = !!this.var_782 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1196.name,this.var_1200.name,this.var_1470.name,this.var_1839.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_783.setText(_loc1_.name);
         this.var_1202.setText(_loc1_.description);
         this.var_971.setText("");
         this.var_1195.setText("");
         ...
         this.setTag(this.var_910,_loc1_.tags[0]);
         ...
         if(this.var_1198)
         {
            ...
            {
               this.var_1198.select();
            }
            else
            {
               this.var_1198.unselect();
            }
         }
         if(this.var_630)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(this.var_73 == null || this._window == null || this._window.disposed)
         {
            return;
         }
         var _loc2_:SaveableRoomSettingsData = new SaveableRoomSettingsData();
         _loc2_.roomId = this.var_73.roomId;
         _loc2_.name = this.var_783.getText();
         _loc2_.description = this.var_1202.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.method_1();
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_615;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_133)
         {
            _loc8_ = this.var_971.getText();
            _loc9_ = this.var_1195.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_971.clearErrors();
               this.var_1195.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1201.isSelected;
         _loc2_.allowFoodConsume = this.var_1203.isSelected;
         _loc2_.allowWalkThrough = this.var_1198.isSelected;
         _loc2_.hideWalls = this.var_630.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_910,_loc2_.tags);
         this.addTag(this.var_911,_loc2_.tags);
         this.clearErrors();
         this.var_1197 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_367);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_73.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_367]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         if(this._navigator.data.guestRoomSearchResults != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(this._navigator.tabs.method_1().id,_loc3_.searchType,_loc3_.searchParam);
         }
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_187,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_260.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_260.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_260.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_260.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_260.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_260.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_260.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_260);
         this.var_260.findChildByName("ruler").visible = true;
         ...
         if(this.var_73.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_260,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_75,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_367));
      }
      ...
      private function onRemoveFlatCtrlClick(param1:WindowEvent) : void
      {
         ...
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_73.controllers)
         {
            if(_loc3_.selected)
            {
