package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1184:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_628 = new Timer(100);
         this.var_628.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,80,"g"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,74,"h"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,416,"o"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,352,"p"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,304,"q"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,336,"r"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,748,"u"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_45,438,"v"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_47,540,"t"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_47,512,"w"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_47,396,"x"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_47,440,"y"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_47,456,"z"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_47,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_628)
         {
            this.var_628.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_628.reset();
            this.var_628 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1184.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1819 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1819 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         var _loc2_:IButtonWindow = this.method_7();
         ...
         this.var_1183 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_180.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1183.goBackToInitialState();
         this.var_1183.input.textBackgroundColor = 4294967295;
         this.var_1184 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         _loc6_.setParamFlag(HabboWindowParam.const_39,false);
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_75,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1183.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1183.getText();
         var _loc3_:String = "model_" + this.var_1184.name;
