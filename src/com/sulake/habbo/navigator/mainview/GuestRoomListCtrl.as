package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_503:RoomPopupCtrl;
      
      private var var_577:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_503 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_577 = IScrollbarWindow(this.var_180.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_577.scrollV = 0;
         }
         this.var_180.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1831,true);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_198)
         {
            this.checkFastHorizontalMove(param1);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(this.var_503.visible && this.var_2346)
            {
               return;
            }
            ...
            this.var_503.room = _loc4_;
            this.var_503.showPopup(param2);
         }
      ...
      {
         var _loc2_:int = 0;
         if(this.var_1424 != null)
         {
            _loc2_ = this.var_1424.tags[0];
            this.var_1424.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2345 - _loc2_.stageX);
         this.var_2345 = _loc2_.stageX;
         this.var_2346 = _loc3_ > 2;
      }
   }
}
