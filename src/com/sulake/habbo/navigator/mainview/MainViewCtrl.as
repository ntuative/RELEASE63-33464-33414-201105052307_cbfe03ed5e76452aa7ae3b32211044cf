package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_2077:int = 3;
      ...
      private static const const_997:int = 3;
      ...
      private var var_899:PopularTagsListCtrl;
      
      private var var_898:GuestRoomListCtrl;
      
      private var var_1108:OfficialRoomListCtrl;
      ...
      private var var_1107:IRegionWindow;
      ...
      private var var_723:WindowToggle;
      
      private const const_1007:Point = new Point(100,10);
      
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_899 = new PopularTagsListCtrl(this._navigator);
         this.var_898 = new GuestRoomListCtrl(this._navigator);
         this.var_1108 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         if(!this.var_723 || this.var_723.disposed)
         {
            this.var_723 = new WindowToggle(this.var_15,this.var_15.desktop,this.reloadData,this.close);
         }
         var _loc1_:int = this.var_723.toggle();
         return _loc1_ == WindowToggle.RESULT_SHOW;
      }
      
      private function reloadData() : void
      {
         var _loc1_:Tab = this._navigator.tabs.method_1();
      ...
      private function prepare() : void
      {
         ...
         this.var_274 = ITabContextWindow(this.var_15.findChildByName("tab_context"));
         if(!this.var_274)
         {
         ...
         this.var_219 = IWindowContainer(this.var_15.findChildByName("custom_content"));
         this.var_197 = IWindowContainer(this.var_15.findChildByName("list_content"));
         this.var_245 = IWindowContainer(this.var_15.findChildByName("custom_footer"));
         this.var_1383 = this.var_15.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_15.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1107 = IRegionWindow(this.var_15.findChildByName("to_hotel_view"));
         if(!this.var_1107)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1107.procedure = this.onHotelView;
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_812,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1568,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_180,["custom_content","list_content"],this.var_219.y,8);
         this.var_197.height = this.var_197.height + _loc1_ - this.var_197.y - this.var_245.height + this.var_2221;
         Util.moveChildrenToColumn(this.var_180,["list_content","custom_footer"],this.var_197.y,0);
         this.var_2221 = this.var_245.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.method_1();
         var _loc2_:ISelectableWindow = this.var_274.selector.method_1();
      ...
      {
         this.refreshList(param1,param2,this.var_898,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_899,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1108,"official_rooms");
      }
      ...
      public function reloadRoomList(param1:int) : Boolean
      {
         ...
         {
            this.startSearch(this._navigator.tabs.method_1().id,param1,"");
            return true;
         }
         return false;
      }
      ...
      {
         var _loc5_:Tab = this._navigator.tabs.method_1();
         this._navigator.tabs.setSelectedTab(param1);
         var _loc6_:Tab = this._navigator.tabs.method_1();
         ErrorReportStorage.addDebugData("StartSearch","Start search " + _loc5_.id + " => " + _loc6_.id);
         this.var_1109 = _loc5_ != _loc6_;
         if(_loc5_ != _loc6_)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_588 == const_996)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_197.blend - _loc2_));
            this.var_197.blend = _loc3_;
            this.var_219.blend = !!this.var_1109 ? Number(_loc3_) : Number(1);
            this.var_245.blend = !!this.var_1109 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_588 = const_656;
            }
         }
         else if(this.var_588 == const_656)
         {
            if(this.var_1384 % 10 == 1)
            {
               this.var_1383.visible = !this.var_1383.visible;
            }
            ++this.var_1384;
            if(!this._navigator.data.isLoading())
            {
               this.var_588 = const_997;
            }
         }
         else if(this.var_588 == const_997)
         {
            this.refresh();
            this.var_588 = const_1362;
         }
         else
         {
            this.var_1383.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_197.blend + _loc2_));
            this.var_197.blend = _loc3_;
            this.var_219.blend = !!this.var_1109 ? Number(_loc3_) : Number(1);
            this.var_245.blend = !!this.var_1109 ? Number(_loc3_) : Number(1);
      ...
      {
         this.refreshScrollbar(this.var_899);
      ...
      {
         this._navigator.refreshButton(this.var_1107,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1107,"icon_hotelview_reactive",param1,null,0);
      }
