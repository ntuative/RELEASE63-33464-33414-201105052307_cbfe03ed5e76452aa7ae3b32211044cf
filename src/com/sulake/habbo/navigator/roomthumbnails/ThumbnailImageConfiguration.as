package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_2041:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_2040 = this._navigator.getButtonImage(this.var_2038);
         }
      ...
      {
         var _loc1_:* = null;
         if(this.var_2041 == null)
         {
            _loc1_ = this.var_682.bitmap.rect;
            this.var_2041 = new Rectangle(this.var_1592,this.var_1592,_loc1_.width - 2 * this.var_1592,_loc1_.height - 2 * this.var_1592);
         }
         this.var_682.bitmap.fillRect(this.var_682.bitmap.rect,4281545523);
         this.var_682.bitmap.fillRect(this.var_2041,4284900966);
         this.copyTo(this.var_682.bitmap);
         if(this._selected)
         {
            this.var_682.bitmap.copyPixels(this.var_2039,this.var_2039.rect,new Point(0,0),null,null,true);
         }
