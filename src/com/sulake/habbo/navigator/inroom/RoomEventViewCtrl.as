package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1699:IWindowContainer;
      
      private var var_2292:ITextWindow;
      
      private var var_1698:ITextWindow;
      
      private var var_1697:ITextWindow;
      
      private var var_1407:IButtonWindow;
      
      private var var_1405:IButtonWindow;
      
      private var var_2293:IButtonWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1699.visible = true;
         this.var_2292.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_728.setText(param1.eventDescription);
         this.var_910.setText(this.getTagFromEvent(param1,1));
         this.var_911.setText(this.getTagFromEvent(param1,2));
         this.var_1407.visible = false;
         this.var_1405.visible = true;
         this.var_1406.visible = true;
         this.var_1698.visible = false;
         this.var_1697.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_912.visible = true;
         this.var_1699.visible = false;
         this.var_1407.visible = true;
         this.var_1405.visible = false;
         this.var_1406.visible = false;
         this.var_728.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_910.goBackToInitialState();
         this.var_911.goBackToInitialState();
         this.var_912.selection = 0;
         this.var_1698.visible = true;
         this.var_1697.visible = false;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_728.getText();
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_728.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1699 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2292 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1698 = ITextWindow(this.find("create_caption"));
            this.var_1697 = ITextWindow(this.find("edit_caption"));
            this.var_1407 = IButtonWindow(this.find("create_button"));
            this.var_1405 = IButtonWindow(this.find("edit_button"));
            this.var_2293 = IButtonWindow(this.find("cancel_button"));
            this.var_1406 = IButtonWindow(this.find("end_button"));
            this.var_912 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1407,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1405,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1406,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2293,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_728 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
