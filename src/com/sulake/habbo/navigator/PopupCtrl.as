package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_432 = new Timer(500,1);
         this.var_352 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1087 = param4;
         this.var_2404 = param2;
         this._popupIndentLeft = param3;
         this.var_432.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_432)
         {
            this.var_432.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_432.reset();
            this.var_432 = null;
         }
         if(this.var_352)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_54 == null)
         {
            this.var_54 = IWindowContainer(this._navigator.getXmlWindow(this.var_1087));
            this.var_54.visible = false;
            this.var_54.setParamFlag(HabboWindowParam.const_39,true);
         ...
         this.var_54.x = _loc2_.x + this.var_2404 + param1.width;
