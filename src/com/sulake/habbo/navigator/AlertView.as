package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_642:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_642[this.var_1087] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
      ...
      {
         var _loc1_:IFrameWindow = this._navigator.getXmlWindow(this.var_1087,2) as IFrameWindow;
