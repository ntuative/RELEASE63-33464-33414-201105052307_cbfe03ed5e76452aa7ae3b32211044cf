package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_35:IRoomWidgetFactory;
      ...
      private var var_1263:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_120:IHabboHelp;
      ...
      private var var_273:PerformanceTracker = null;
      
      private var var_448:FramerateTracker = null;
      
      private var var_272:LatencyTracker = null;
      
      private var var_664:LagWarningLogger = null;
      
      private var var_663:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_273 = new PerformanceTracker();
         this.var_448 = new FramerateTracker();
         this.var_272 = new LatencyTracker();
         this.var_664 = new LagWarningLogger();
         this.var_663 = new ToolbarClickTracker(this);
         this.var_1553 = new Array(const_1066);
         var _loc4_:int = 0;
         while(_loc4_ < const_1066)
         {
            this.var_1553[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1562,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1570,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1628,Capabilities.serverString);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1263)
            {
               this.var_1263.release(new IIDHabboWindowManager());
               this.var_1263 = null;
            }
            if(this.var_309)
            {
            ...
            if(this.var_35)
            {
               this.var_35.release(new IIDHabboRoomWidget());
               this.var_35 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_210)
            {
               if(!this.var_210.disposed)
               {
                  ...
                  Component(this.var_210).events.removeEventListener(HabboFriendListTrackingEvent.const_395,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_120)
            {
               if(!this.var_120.disposed)
               {
                  this.var_120.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_120.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_120.release(new IIDHabboHelp());
               this.var_120 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_201,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_308,this.onRoomAction);
            ...
            {
               this.var_316.stop();
               this.var_316.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_316 = null;
            }
      ...
      {
         this.var_1553[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_183 = IHabboConfigurationManager(param2);
         if(this.var_183)
         {
            if(this.var_272 != null)
            {
               this.var_272.configuration = this.var_183;
            }
            if(this.var_273 != null)
            {
               this.var_273.configuration = this.var_183;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1719);
            if(this.var_183)
            {
               if(this.var_664 != null)
               {
                  this.var_664.configure(this.var_183);
               }
               if(this.var_448 != null)
               {
                  this.var_448.configure(this.var_183);
               }
               if(this.var_663 != null)
               {
                  this.var_663.configure(this.var_183);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_944,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_226,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_254,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_830,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_73,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_589,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_664 != null)
            {
               this.var_664.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_830)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1721);
         }
         else if(param1.type == HabboHotelViewEvent.const_589)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1590);
         }
         else if(param1.type == HabboHotelViewEvent.const_73)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1797);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1717);
               break;
            case HabboCommunicationEvent.const_944:
               this.trackLoginStep(HabboLoginTrackingStep.const_1716,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_226:
               this.trackLoginStep(HabboLoginTrackingStep.const_226);
               break;
      ...
      {
         this.var_1263 = IHabboWindowManager(param2);
         if(this.var_1263)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_183)
            {
               if(this.var_183.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_183.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1553)
                  {
                  ...
                  if(this.var_273 != null)
                  {
                     _loc4_["null"] = this.var_273.flashVersion;
                     _loc4_["null"] = this.var_273.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1286);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1286,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_210).events.addEventListener(HabboFriendListTrackingEvent.const_395,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_395:
      ...
      {
         this.var_35 = param2 as IRoomWidgetFactory;
         Component(this.var_35).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_35).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_35).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_35).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_120 = param2 as IHabboHelp;
         this.var_120.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_120.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2709)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1803);
            this.var_2709 = true;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_201,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_308,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_309.events.addEventListener(AdEvent.const_509,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_308)
         {
            if(this.var_1953 < 1)
            {
               if(!this.var_316)
               {
                  this.var_316 = new Timer(60000,1);
                  this.var_316.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_316.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_354)
         {
            if(this.var_316)
            {
               this.var_316.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_448)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_448.frameRate),_loc2_);
                  ++this.var_1953;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_663)
         {
            this.var_663.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_183 != null && !Boolean(this.var_183.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_664.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1951;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1951);
         }
         if(this.var_536 > -1 && _loc2_ - this.var_536 > 15000)
         {
            ++this.var_1952;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1952);
         }
         this.var_536 = _loc2_;
         if(this.var_273 != null)
         {
            this.var_273.update(param1,this.var_536);
         }
         if(this.var_272 != null)
         {
         ...
         if(this.var_448 != null)
         {
            this.var_448.trackUpdate(param1,this,this.var_536);
         }
         if(this.var_664 != null)
         {
            this.var_664.update(this.var_536);
         }
      }
   }
}
