package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_53:IRoomContentLoader;
      ...
      private var var_149:IRoomManagerListener;
      
      private var var_2997:IRoomContentLoader;
      
      private var var_584:IRoomObjectFactory = null;
      
      private var var_487:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1095:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_585 = [];
         this.var_586 = [];
         events.addEventListener(RoomContentLoadedEvent.const_378,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_633,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_711,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_584 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_584 == null || this.var_487 == null)
         {
            return;
         }
         this._state = const_1670;
         if(this.var_1095 != null)
         {
            _loc1_ = this.var_1095;
            this.var_1095 = null;
            this.initialize(_loc1_,this.var_149);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         this.var_1114 = 50;
         this.var_149 = param2;
         var _loc3_:Array = this.var_53.getPlaceHolderTypes();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            _loc5_ = _loc3_[_loc4_];
            if(this.var_585.indexOf(_loc5_) < 0)
            {
               this.var_53.loadObjectContent(_loc5_,events);
               this.var_585.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1318;
         return true;
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(!this.var_53.hasInternalContent(param3))
         {
            _loc7_ = this.var_53.getGraphicAssetCollection(param3);
            if(_loc7_ == null)
            {
               this.var_53.loadObjectContent(param3,events);
               _loc12_ = this.var_53.getPlaceHolderType(param3);
               _loc7_ = this.var_53.getGraphicAssetCollection(_loc12_);
            }
            _loc8_ = this.var_53.getVisualizationXML(_loc12_);
            _loc9_ = this.var_53.getLogicXML(_loc12_);
            if(_loc8_ == null || _loc7_ == null)
            {
               return null;
            }
            _loc10_ = this.var_53.getVisualizationType(_loc12_);
            _loc11_ = this.var_53.getLogicType(_loc12_);
         }
         else
         {
            _loc10_ = param3;
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_584.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_584 != null)
         {
            return this.var_584.createRoomObjectManager();
         }
         return null;
      }
      ...
      public function isContentAvailable(param1:String) : Boolean
      {
         if(this.var_53 != null)
         {
            if(this.var_53.getGraphicAssetCollection(param1) != null)
            {
               return true;
            }
         }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_53.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_585.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_585.splice(_loc2_,1);
            }
            if(this.var_585.length == 0)
            {
               this._state = const_931;
               if(this.var_149 != null)
               {
                  this.var_149.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_786;
            this.var_149.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_149 != null)
            {
               this.var_149.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_890.indexOf(_loc2_) < 0)
         {
            this.var_890.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_890.length > 0)
         {
            _loc2_ = this.var_890[0];
            this.var_890.splice(0,1);
            _loc3_ = this.var_53.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_149 != null)
               {
                  this.var_149.contentLoaded(_loc2_,false);
               }
               return;
            }
            _loc4_ = this.var_53.getGraphicAssetCollection(_loc2_);
            if(_loc4_ == null)
            {
               if(this.var_149 != null)
               {
            ...
            if(this.var_149 != null)
            {
               this.var_149.contentLoaded(_loc2_,true);
            }
            if(this.var_585.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_53 == null || this.var_487 == null)
         {
            return;
         }
         var _loc2_:XML = this.var_53.getVisualizationXML(param1);
         var _loc3_:XML = this.var_53.getLogicXML(param1);
         var _loc4_:IGraphicAssetCollection = this.var_53.getGraphicAssetCollection(param1);
         if(_loc2_ == null || _loc4_ == null)
         {
            return;
         }
         var _loc5_:String = this.var_53.getVisualizationType(param1);
         var _loc6_:String = this.var_53.getLogicType(param1);
         var _loc7_:IRoomObjectVisualizationData = this.var_487.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_487.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_584.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_149 != null)
                              {
                                 this.var_149.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
