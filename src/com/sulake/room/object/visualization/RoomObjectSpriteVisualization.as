package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_173:int = -1;
      
      protected var var_89:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_203 != null)
         {
            ...
            {
               _loc1_ = this.var_203[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_781.removeReference();
         }
         this.var_781 = param1;
         if(this.var_781 != null)
         {
            this.var_781.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_203.length > param1)
         {
            _loc2_ = this.var_203[this.var_203.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         this.var_477 = 4294967295;
         this.var_173 = 4294967295;
         this.var_89 = -1;
      }
