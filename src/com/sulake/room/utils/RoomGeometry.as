package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_969:Number = 64;
      
      public static const const_1255:Number = 32;
      ...
      private var var_1313:Vector3d;
      
      private var var_459:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1314:Vector3d;
      ...
      private var var_2047:Number = 1.0;
      
      private var var_2046:Number = 1.0;
      
      private var var_2045:Number = 1.0;
      ...
      private var var_2989:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1313 = new Vector3d();
         this.var_459 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1314 = new Vector3d();
         this.var_2047 = 1;
         this.var_2046 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2045 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_459.assign(this.var_93);
         this.var_459.x *= this.var_462;
         this.var_459.y *= this.var_460;
         this.var_459.z *= this.var_461;
         return this.var_459;
      }
      ...
      {
         if(this.var_462 != param1 * this.var_2047)
         {
            this.var_462 = param1 * this.var_2047;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_460 != param1 * this.var_2046)
         {
            this.var_460 = param1 * this.var_2046;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_461 != param1 * this.var_2045)
         {
            this.var_461 = param1 * this.var_2045;
            ++this.var_168;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_93.x /= this.var_462;
         this.var_93.y /= this.var_460;
         this.var_93.z /= this.var_461;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_463.x;
         var _loc3_:Number = this.var_463.y;
         var _loc4_:Number = this.var_463.z;
         this.var_463.assign(param1);
         this._direction.assign(param1);
         if(this.var_463.x != _loc2_ || this.var_463.y != _loc3_ || this.var_463.z != _loc4_)
         {
            ++this.var_168;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_157.assign(_loc24_);
            this.var_156.assign(_loc25_);
            this.var_1313.assign(this.var_156);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_157.assign(_loc19_);
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_554 != null)
         {
            ...
            return this.var_554.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1314.assign(_loc22_);
         }
         else
         {
            this.var_1314.assign(_loc17_);
         }
         ++this.var_168;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_157);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_462;
         _loc2_.y *= this.var_460;
         _loc2_.z *= this.var_461;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1314);
         if(_loc3_ < this.var_2988 || _loc3_ > this.var_2989)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_157);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_460;
            _loc2_.z *= this.var_461;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1314);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_157,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_93.x * this.var_462,this.var_93.y * this.var_460,this.var_93.z * this.var_461);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_156;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_462,param2.y * this.var_460,param2.z * this.var_461);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_462,param3.y * this.var_460,param3.z * this.var_461);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_462,param4.y * this.var_460,param4.z * this.var_461);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1255;
         }
         else
         {
            this.scale = const_969;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_969;
      }
