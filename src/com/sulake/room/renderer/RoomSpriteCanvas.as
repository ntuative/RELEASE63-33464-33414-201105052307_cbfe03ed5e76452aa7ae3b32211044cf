package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_370:int = 50;
      
      private static const const_1400:int = 50;
      
      private static const const_1018:Number = 60;
      
      private static const const_1399:Number = 50;
      ...
      private var var_498:Point;
      
      private var var_252:BitmapDataCache;
      
      private var var_599:RoomObjectCache;
      
      private var var_499:Array;
      
      private var var_595:Array;
      
      private var var_1416:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2324:Number = -1.0E7;
      
      private var var_2323:Number = -1.0E7;
      ...
      private var var_1727:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_251.addChild(this.var_97);
         ...
         this.var_599 = new RoomObjectCache(_loc6_);
         this.var_744 = new ColorTransform();
         this.var_596 = new Matrix();
      ...
      {
         this.var_498.x -= param1 - this.var_597;
         this.var_597 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_498.y -= param1 - this.var_598;
         this.var_598 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_950 = true;
            if(this.var_129 != null && !this.var_251.contains(this.var_129))
            {
               this.var_251.addChild(this.var_129);
               this.var_97.mask = this.var_129;
            }
         }
         else if(!param1 && this.var_950)
         {
            this.var_950 = false;
            if(this.var_129 != null && this.var_251.contains(this.var_129))
            {
               this.var_251.removeChild(this.var_129);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_595.length)
            {
               this.cleanSprite(this.var_595[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_595 = [];
         }
      ...
      {
         this.var_599.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1728 = !this.var_1728;
         ...
         if(this.var_500 != this.var_2322 || this.var_497 != this.var_2325)
         {
            _loc8_ = true;
         }
         if(this.var_97.x != this.var_597 || this.var_97.y != this.var_598)
         {
            this.var_97.x = this.var_597;
            this.var_97.y = this.var_598;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_499.sortOn("z",0 | 0);
         if(_loc5_ < this.var_499.length)
         {
            this.var_499.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_499[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2322 = this.var_500;
         this.var_2325 = this.var_497;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1415 > 0)
         {
            ...
            if(_loc2_ > const_1018 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2320 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_742;
               if(this.var_742 == const_370 + 1)
               {
                  this.var_555 = _loc2_;
                  this.var_1727 = this.var_2321;
               }
               else if(this.var_742 > const_370 + 1)
               {
                  _loc3_ = Number(this.var_742 - const_370);
                  this.var_555 = this.var_555 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1727 = this.var_1727 * (_loc3_ - 1) / _loc3_ + Number(this.var_2321) / _loc3_;
                  if(this.var_742 > const_370 + const_1400)
                  {
                     this.var_742 = const_370;
                     if(!this.var_1139 && this.var_555 > const_1018)
                     {
                        this.var_1139 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1139 && this.var_555 < const_1399)
                     {
                        this.var_1139 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_599.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_599.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1728 && this.var_1139);
         ...
         _loc13_ += int(this.var_500 / 2);
         _loc14_ += int(this.var_497 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_597;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_598;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_499.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_597;
                     _loc17_.y = _loc20_ - this.var_598;
      ...
      {
         if(param1 < this.var_500 && param1 + param3 >= 0 && (param2 < this.var_497 && param2 + param4 >= 0))
         {
            if(!this.var_2959)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_500)
         {
            param3 -= this.var_500 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_497)
         {
            param4 -= this.var_497 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2319)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_923)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_595.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_923)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_743 || this.var_743 == 0)
         {
            _loc4_ = this.var_923 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_499[param1] as SortableSprite;
      }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_596.identity();
            if(flipH)
            {
               this.var_596.scale(-1,1);
               this.var_596.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_596.scale(1,-1);
               this.var_596.translate(0,data.height);
            }
            finalData.draw(data,this.var_596);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_663);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_744.redMultiplier = tR;
            this.var_744.greenMultiplier = tG;
            this.var_744.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_744);
            if(name.length > 0)
            {
               this.var_252.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_597;
         param2 -= this.var_598;
         this.var_498.x = param1;
         this.var_498.y = param2;
         if(this.var_1140 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1729;
         }
         this.var_1729 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1140;
         return this.var_1729;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_500 / 2;
         var _loc12_:Number = param2 - this.var_497 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1726,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2324 || param2 != this.var_2323)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_348.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1416.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1140 == 0)
         {
            this.checkMouseHits(this.var_498.x,this.var_498.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1140 = 0;
         ++this.var_1726;
      }
