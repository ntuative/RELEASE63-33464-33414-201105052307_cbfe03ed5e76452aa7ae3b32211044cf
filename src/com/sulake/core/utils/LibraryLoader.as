package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1850:uint = 1;
      
      protected static const const_1851:uint = 2;
      
      protected static const const_1852:uint = 4;
      
      protected static const const_1853:uint = 3;
      ...
      public static const const_1128:Boolean = false;
      
      public static const const_1678:int = 2;
      
      private static var var_1025:Array = new Array();
      ...
      protected var var_242:URLRequest;
      
      protected var _manifest:XML;
      
      protected var var_606:Class;
      
      protected var var_479:uint = 0;
      
      protected var _name:String;
      
      protected var var_1090:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1091:Boolean = false;
      
      protected var var_2941:String = "";
      
      protected var var_2942:String = "";
      
      protected var var_2160:int;
      
      protected var var_1353:int;
      
      protected var var_1352:int;
      
      protected var var_3022:uint = 0;
      
      protected var var_2943:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_42.load(param1.var_242,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1128)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_818[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_818.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_818.length < const_1678 && false)
            {
               _loc1_ = var_1025.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_818.push(_loc1_);
                  _loc1_.var_42.load(_loc1_.var_242,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_242 ? this.var_242.url : null;
      }
      ...
      {
         return !!this.var_1090 ? uint(this.var_1353 - this.var_2160) : uint(getTimer() - this.var_2160);
      }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_242.url);
      ...
      {
         if(this.var_1091 && !_disposed)
         {
            this.var_1091 = false;
            if(!this.var_1090 && this.var_242)
            {
               this.var_1353 = -1;
      ...
      {
         if(!this.var_1090 && !_disposed && this.var_1352 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_242,const_1777 - this.var_1352);
            if(this.var_2943)
            {
               this.var_242.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_242.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2943 = false;
            }
            --this.var_1352;
            this.var_479 = 0;
            this.var_42.load(this.var_242,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case IOErrorEvent.IO_ERROR:
               ...
               if(!this.method_16(this.var_406))
               {
                  this.var_1353 = getTimer();
         ...
         if(this.var_479 == LibraryLoader.const_1853)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_606 = this.getDefinition(this._name) as Class;
         if(this.var_606 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_242.url + "!");
            }
            return false;
         }
         ...
         try
         {
            xmlClass = this.var_606.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
      ...
      protected function method_16(param1:int) : Boolean
      {
