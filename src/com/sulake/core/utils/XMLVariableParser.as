package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1577:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1611:String = "bool";
      ...
      private static const const_677:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_676:String = "value";
      
      private static const const_652:String = "true";
      
      private static const const_1897:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_677);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_677));
         }
         else
         {
            _loc4_ = param1.child(const_677)[0];
         }
         ...
         _loc7_ = param1.attribute(const_676);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_676));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_676)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_291 || _loc5_ == const_149)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1577:
               return Number(param1);
            case const_38:
               return param1 == const_652 || int(param1) > 0;
            case const_1611:
               return param1 == const_652 || int(param1) > 0;
            case const_166:
               return uint(param1);
            case const_149:
               return param1.split(const_1341);
            default:
