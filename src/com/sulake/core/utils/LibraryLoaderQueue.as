package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1678:int = 4;
      ...
      {
         return this.var_447.length + this.var_285.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_285.length < const_1678 && this.var_447.length > 0)
            {
               _loc1_ = this.var_447.shift();
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_447.indexOf(loader);
            if(index > -1)
            {
               this.var_447.splice(index,1);
            }
