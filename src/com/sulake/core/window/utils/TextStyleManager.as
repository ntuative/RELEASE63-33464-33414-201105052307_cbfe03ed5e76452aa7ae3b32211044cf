package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_546:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_678:String = "{";
      
      private static const const_679:String = "}";
      
      private static const const_1504:String = "/*";
      
      private static const const_1503:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_86[const_219],var_86[ITALIC],var_86[BOLD]];
            var_86.reset();
            var_86[const_219] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_546.indexOf(_loc4_.name) == -1)
            {
               var_546.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_679);
         if(countSubStrings(param1,const_678) != countSubStrings(param1,const_679))
         {
            throw new Error("Mismatching amount of \"" + const_678 + "\" versus \"" + const_679 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1504) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1503) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_678)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
