package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_337 = new Array();
            var_337[0] = MouseCursorType.const_343;
            var_337[1] = MouseCursorType.const_30;
            var_337[2] = MouseCursorType.const_343;
            var_337[3] = MouseCursorType.const_343;
            var_337[4] = MouseCursorType.const_343;
            var_337[5] = MouseCursorType.const_30;
            var_337[6] = MouseCursorType.const_343;
         }
         if(var_290 == null)
         {
            var_290 = new Array();
            var_290[0] = WindowState.const_94;
            var_290[1] = WindowState.const_89;
            var_290[2] = WindowState.const_88;
            var_290[3] = WindowState.const_69;
            var_290[4] = WindowState.const_54;
            var_290[5] = WindowState.const_100;
            var_290[6] = WindowState.const_87;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_200;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_61 = state.var_1336 as WindowController;
         this.var_172 = state.var_1335 as WindowController;
         this.var_163 = state.renderer;
         this.var_869 = state.var_1334;
         eventQueue.begin();
         this.var_701.x = -1;
         this.var_701.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_701.x || event.stageY != this.var_701.y)
            {
               this.var_701.x = event.stageX;
               this.var_701.y = event.stageY;
               array = new Array();
               this.var_80.groupParameterFilteredChildrenUnderPoint(this.var_701,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_61.getGlobalPosition(var_409);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_61 && !this.var_61.disposed)
                     {
                        ...
                        {
                           this.var_869.mouseEventReceived(event.type,this.var_61);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1336 = this.var_61;
         state.var_1335 = this.var_172;
         state.renderer = this.var_163;
         state.var_1334 = this.var_869;
      }
