package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2094:String = "_TEMP";
      
      private static const const_1333:String = "layout";
      
      private static const const_992:String = "window";
      
      private static const const_991:String = "variables";
      
      private static const const_990:String = "filters";
      
      private static const const_453:String = "name";
      
      private static const const_1331:String = "style";
      
      private static const const_653:String = "params";
      
      private static const const_1339:String = "tags";
      ...
      private static const const_1340:String = "visible";
      
      private static const const_1336:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1227:String = "blend";
      
      private static const const_1337:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1343:String = "treshold";
      
      private static const const_1334:String = "children";
      
      private static const const_1335:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1342:String = "height_min";
      
      private static const const_1345:String = "height_max";
      
      private static const const_652:String = "true";
      
      private static const const_181:String = "0";
      
      private static const const_1332:String = "$";
      
      private static const const_1341:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1344:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1338:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1082:Dictionary;
      
      protected var var_1627:Dictionary;
      
      protected var var_2141:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1339,this.var_1338);
         this.var_1082 = new Dictionary();
         this.var_1627 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1082,this.var_1627);
         this.var_2141 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1338,const_50);
         return param1.replace(const_1344,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1082)
            {
               delete this.var_1082[_loc1_];
            }
            for(_loc1_ in this.var_1627)
            {
               delete this.var_1627[_loc1_];
            }
            this.var_2141.dispose();
            this.var_2141 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1333)
         {
            _loc8_ = param1.child(const_991);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_990).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1339[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_453,variables,"")));
         style = uint(this.parseAttribute(xml,const_1331,variables,style));
         params = uint(this.parseAttribute(xml,const_653,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1339,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1340,variables,visible.toString()) == const_652;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_653).length() > 0)
         {
            list = xml.child(const_653).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_453,variables,"") as String;
               if(this.var_1082[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_453)) + "\"!");
               }
               params |= this.var_1082[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1336,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1341);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_991)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1335,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1342,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1345,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_652;
         blend = Number(this.parseAttribute(xml,const_1227,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1337,variables,window.clipping.toString()) == const_652;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1343,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_990).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_202)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1338[param1.type];
