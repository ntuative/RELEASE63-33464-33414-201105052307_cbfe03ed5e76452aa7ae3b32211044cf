package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_321:int = 2.147483647E9;
      ...
      {
         this.var_323 = param1;
         if(this.var_323 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_323)
         {
      ...
      {
         this.var_321 = param1;
         if(this.var_321 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_321)
         {
      ...
      {
         this.var_320 = param1;
         if(this.var_320 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_320)
         {
      ...
      {
         return this.var_323 == int.MIN_VALUE && this.var_321 == int.MAX_VALUE && this.var_320 == int.MIN_VALUE && this.var_322 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_323 = int.MIN_VALUE;
         this.var_321 = int.MAX_VALUE;
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_323)
            {
               this._target.width = this.var_323;
            }
            else if(this._target.width > this.var_321)
            {
               this._target.width = this.var_321;
            }
            if(this._target.height < this.var_320)
            {
               this._target.height = this.var_320;
            }
