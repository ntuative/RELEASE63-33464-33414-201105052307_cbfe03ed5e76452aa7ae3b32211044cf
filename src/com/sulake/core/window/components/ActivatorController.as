package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_338)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1262)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_872;
         if(this.var_872 != param1)
         {
            if(this.var_872 != null)
            {
               if(!this.var_872.disposed)
               {
                  this.var_872.deactivate();
               }
            }
            this.var_872 = param1;
