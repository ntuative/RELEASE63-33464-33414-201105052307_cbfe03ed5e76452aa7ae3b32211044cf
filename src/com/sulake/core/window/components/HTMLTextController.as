package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_979:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_980:String = "default";
      
      private var var_1214:String = null;
      
      private var var_1861:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1214 == param2)
         {
            return;
         }
         param1.var_1214 = param2;
         param1.var_1861 = null;
         if(param1.var_1214 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1214);
            param1.var_1861 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_723.indexOf(param1) > -1)
         {
            this.var_980 = param1;
         }
      }
      ...
      {
         return this.var_980 == LinkTarget.const_30 ? defaultLinkTarget : this.var_980;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1861;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1292)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_980 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_781,this.var_980,PropertyStruct.const_53,true,PropertyDefaults.const_723));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1656);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_781)
            {
               this.var_980 = _loc2_.value as String;
               break;
            }
