package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1527:String = "_SELECTOR";
      
      private static const const_1526:String = "_CONTENT";
       
      
      protected var var_1093:ITabSelectorWindow;
      
      protected var var_2164:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1093 = findChildByTag(const_1527) as ITabSelectorWindow;
            if(this.var_1093 != null)
            {
               this.var_1093.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2164 = findChildByTag(const_1526) as IWindowContainer;
         }
      ...
      {
         return !!this.var_718 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1093.numSelectables;
      }
