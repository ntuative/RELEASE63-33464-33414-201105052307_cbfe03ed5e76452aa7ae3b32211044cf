package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1472:String = "increment";
      
      private static const const_1473:String = "decrement";
      
      private static const const_1061:String = "slider_track";
      
      private static const const_674:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_706:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_174 = false;
         this.var_16 = param12;
         this._horizontal = param2 == WindowType.const_578;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_16 != null && !this.var_16.disposed)
         {
            ...
            this.var_16.removeEventListener(WindowEvent.const_525,this.onScrollableScrolled);
         }
         this.var_16 = param1;
         if(this.var_16 != null && !this.var_16.disposed)
         {
            this.var_16.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_16.addEventListener(WindowEvent.const_525,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1006 != null)
         {
            _loc2_ = this.var_1006;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1006 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return this.track.findChildByName(const_674) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_674:
         ...
         if(param2.type == WindowEvent.const_624)
         {
            if(this.var_16 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_357)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_706;
                  }
                  else
                  {
                     this.scrollV -= this.var_706;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_849)
         {
            ...
            else if(param2.name == const_1473)
            {
               if(this.var_16)
               {
                  this.var_1242 = true;
            ...
            else if(param2.name == const_1061)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_674).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_357)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1006) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1006) as IScrollableWindow;
               if(_loc1_)
               {
