package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1635:uint = 500;
      
      protected var var_1357:String = "";
      
      protected var var_1341:Boolean = false;
      
      protected var var_718:Boolean = false;
      ...
      {
         this.var_1357 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_20)
         {
            var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1174,var_11);
         }
         return var_20;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_718 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_174,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_432,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_360,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_104,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_934,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1802);
         _loc1_.push(this.var_1341 != PropertyDefaults.const_1306 ? new PropertyStruct(PropertyDefaults.const_702,this.var_1341,PropertyStruct.const_38,true) : PropertyDefaults.const_1609);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1111 ? new PropertyStruct(PropertyDefaults.const_920,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1751);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1305 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1796);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_702:
                  this.var_1341 = _loc2_.value as Boolean;
                  if(this.var_1341)
                  {
               ...
               case PropertyDefaults.const_920:
                  ...
                  break;
               case PropertyDefaults.const_934:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1256:
