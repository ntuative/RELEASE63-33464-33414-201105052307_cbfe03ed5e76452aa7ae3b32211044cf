package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1328:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_876:Number;
      
      protected var var_577:Number;
      
      protected var var_576:Boolean;
      
      protected var var_39:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_126:Boolean = false;
      
      protected var var_1092:Boolean = false;
      
      private var var_453:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_453,this._explicitStyle);
      ...
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         if(param1.var_39)
         {
            param1.var_39.assign(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         else
         {
            param1.var_39 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         param1.refreshTextImage();
      }
      ...
      {
         if(param1.var_39 && param1.var_39.left != param2)
         {
      ...
      {
         if(param1.var_39 && param1.var_39.top != param2)
         {
      ...
      {
         if(param1.var_39 && param1.var_39.right != param2)
         {
      ...
      {
         if(param1.var_39 && param1.var_39.bottom != param2)
         {
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_453 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_453,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_889 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_453);
      }
      ...
      {
         this.var_876 = param1;
         this._field.scrollH = this.var_876 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_876 * this.maxScrollH,this.var_577 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_39 = this.var_39.clone(_loc1_.setTextMargins);
         _loc1_._autoSize = this._autoSize;
         _loc1_.var_126 = this.var_126;
         return _loc1_;
      }
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_576 = true;
         var _loc2_:int = this.var_39.left + this.var_39.right;
         var _loc3_:int = this.var_39.top + this.var_39.bottom;
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_453);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_704,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1313));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1183 ? new PropertyStruct(PropertyDefaults.const_884,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1139) : PropertyDefaults.const_1766);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_166,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_249,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1092 ? new PropertyStruct(PropertyDefaults.const_1137,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1200) : PropertyDefaults.const_1690);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_842) ? new PropertyStruct(PropertyDefaults.const_443,this._field.textColor,PropertyStruct.const_166,true) : PropertyDefaults.const_1180);
         _loc1_.push(this.var_453 != TextStyleManager.const_219 ? new PropertyStruct(PropertyDefaults.const_414,this.var_453,PropertyStruct.const_53,true,PropertyDefaults.const_760) : PropertyDefaults.const_1146);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_964 ? new PropertyStruct(PropertyDefaults.const_279,this.var_39.left,PropertyStruct.const_43,true) : PropertyDefaults.const_620);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_847 ? new PropertyStruct(PropertyDefaults.const_260,this.var_39.top,PropertyStruct.const_43,true) : PropertyDefaults.const_634);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_773 ? new PropertyStruct(PropertyDefaults.const_268,this.var_39.right,PropertyStruct.const_43,true) : PropertyDefaults.const_476);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_843 ? new PropertyStruct(PropertyDefaults.const_287,this.var_39.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_474);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1219 ? new PropertyStruct(PropertyDefaults.const_967,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1810);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_124,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_124,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_124,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
