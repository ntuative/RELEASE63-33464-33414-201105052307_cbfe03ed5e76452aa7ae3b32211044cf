package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1158:IItemListWindow;
      
      private var var_430:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_430)
         {
            this.var_430.removeEventListener(WindowEvent.const_278,this.scrollBarEventProc);
            this.var_430.removeEventListener(WindowEvent.const_203,this.scrollBarEventProc);
            this.var_430 = null;
         }
         if(this.var_1158)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1158)
         {
            this.var_1158 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_430)
         {
            this.var_430 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_430)
            {
               this.var_430.addEventListener(WindowEvent.const_278,this.scrollBarEventProc);
               this.var_430.addEventListener(WindowEvent.const_203,this.scrollBarEventProc);
            }
         }
         return this.var_430;
      }
