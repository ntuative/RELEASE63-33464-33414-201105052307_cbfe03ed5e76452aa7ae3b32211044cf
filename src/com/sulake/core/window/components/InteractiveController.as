package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_486)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_803:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_486)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_803,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1629);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1094)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_821,param1.toolTipDelay,PropertyStruct.const_249,true));
         }
         else
         {
      ...
      {
         this.var_1357 = param1 == null ? "null" : param1;
      }
