package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2145:Boolean = false;
      ...
      protected var var_1086:Boolean = true;
      
      protected var var_476:Boolean = false;
      
      protected var var_1344:Boolean = false;
      
      protected var var_2146:int = 0;
      
      protected var var_2147:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_107 = 0;
         this.var_94 = 0;
         this._horizontal = param2 == WindowType.const_449;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_174 = var_481 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_438,WindowStyle.const_132,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_41,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_401,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_142,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_204,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1344;
      }
      ...
      {
         return new Rectangle(this.var_704 * this.maxScrollH,this.var_702 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_704)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_525,this,null);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_702 = param1;
            this._container.y = -this.var_702 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_525,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_538,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_473,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_401,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_142,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_198:
               if(this.var_1343)
               {
                  this.var_1342 = this.var_2146 - _loc3_;
                  this.var_1345 = this.var_2147 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1342 != 0 && this.var_107 != 0)
                     {
                        this.scrollH += this.var_1342 / this.var_107;
                     }
                  }
                  else if(this.var_1345 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1345 / this.var_94;
                  }
                  this.var_2146 = _loc3_;
                  this.var_2147 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_200:
               if(this.var_1343)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1342,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1086 && !this.var_574 && this._container)
         {
            this.var_574 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_926)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_396,this._spacing,PropertyStruct.const_43,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1288);
         }
         if(this.var_1086 != PropertyDefaults.const_1214)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_804,this.var_1086,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1787);
         }
         if(this.var_476 != PropertyDefaults.const_1095)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_805,this.var_476,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1636);
         }
         if(this.var_1344 != PropertyDefaults.const_1224)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_735,this.var_1344,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1772);
         }
         if(this.var_705 != PropertyDefaults.const_1155)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_925,this.var_705,PropertyStruct.const_124,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1718);
         }
         if(this.var_703 != PropertyDefaults.const_1134)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_737,this.var_703,PropertyStruct.const_124,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_396:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_805:
               ...
               case PropertyDefaults.const_804:
                  this.var_1086 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_925:
                  this.var_705 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_737:
