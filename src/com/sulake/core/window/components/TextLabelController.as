package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_368:Object = null;
      ...
      {
         return this.var_368 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_453);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_368 != null)
            {
               _loc1_.textColor = uint(this.var_368);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_453 != param1.name)
         {
            this.var_453 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2571 = _loc2_.textWidth;
         this.var_2570 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_368 != _loc2_.color : this.var_368 != null && this.var_368 != PropertyDefaults.const_842) ? new PropertyStruct(PropertyDefaults.const_443,this.var_368,PropertyStruct.const_166,true) : PropertyDefaults.const_1180);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_964)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_279,this.var_39.left,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_620);
            }
            if(this.var_39.top != PropertyDefaults.const_847)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,this.var_39.top,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_634);
            }
            if(this.var_39.right != PropertyDefaults.const_773)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,this.var_39.right,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_476);
            }
            if(this.var_39.bottom != PropertyDefaults.const_843)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_287,this.var_39.bottom,PropertyStruct.const_43,true));
            }
            else
            {
