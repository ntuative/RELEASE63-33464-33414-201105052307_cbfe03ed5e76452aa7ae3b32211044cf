package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_450:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_593:int = -1;
      
      private var var_909:Boolean = false;
      
      private var var_175:DropMenuController;
      ...
      {
         if(param1 > this.var_247.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_315,this,null,true);
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            ...
            this.var_593 = param1;
            this.closeMenuView();
            _loc2_ = WindowEvent.allocate(WindowEvent.const_59,this,null);
            this.update(this,_loc2_);
         }
         _loc2_.recycle();
      }
      ...
      {
         if(this.var_175 != null && !this.var_175.disposed)
         {
            this.var_175.destroy();
            this.var_175 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_450) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_175 == null || this.var_175.disposed)
         {
            this.var_175 = context.create(name + "::submenu","",WindowType.const_565,var_76,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_175.setGlobalRectangle(_loc1_);
         }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_247.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_909 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_175.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_909)
         {
            if(this.open())
            {
               if(this.var_247.length)
               {
                  this.populateMenuItemContainer(this.var_247,this.getSubMenu(),this.subMenuEventProc);
                  this.var_909 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_909 = false;
            this.getTitleLabel().text = this.var_593 < this.var_247.length && this.var_593 > -1 ? this.var_247[this.var_593] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_603,var_76,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_438,var_76,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_593 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_593).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_849)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1171:
            case WindowMouseEvent.const_52:
               ...
               break;
            case WindowTouchEvent.const_765:
      ...
      {
         if(getStateFlag(WindowState.const_108))
         {
            return true;
         }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1600,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1696,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_247.length)
            {
               _loc1_.push(this.var_247[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_247.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_928,this.var_247,PropertyStruct.const_149,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1608);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_928)
            {
