package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_578:uint;
      
      protected var var_482:uint = 10;
      
      protected var var_710:Boolean = true;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this._type = param3;
         this.var_18 = param5;
         this._state = WindowState.const_108;
         this.var_76 = param4;
         this.var_877 = param8 == null ? new Array() : param8;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this._context = null;
            this._state = WindowState.const_639;
            this.var_877 = null;
         }
      }
