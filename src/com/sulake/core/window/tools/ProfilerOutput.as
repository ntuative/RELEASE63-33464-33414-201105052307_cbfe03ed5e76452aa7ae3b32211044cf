package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1548:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1549:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_164:IProfiler;
      
      private var var_22:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_2982:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2982 = new Array();
         this.var_164 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1548() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_164)
         {
            this.var_164.removeStopEventListener(this.refresh);
            this.var_164 = null;
         }
         if(!this.var_164 && param1)
         {
            this.var_164 = param1;
            this.var_164.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_577)
            {
               this.var_1945 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_164.getProfilerAgentsInArray();
         ...
         if(this.var_1945)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_164.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_164.numBitmapAssetInstances + " / " + this.var_164.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_164.numTrackedBitmapDataInstances + " / " + this.var_164.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1549() as ByteArray;
