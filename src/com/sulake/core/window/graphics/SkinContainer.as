package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1065:uint = 8;
      
      private static const const_1492:String = "skin";
      
      private static const const_1488:String = "bitmap";
      
      private static const const_1491:String = "fill";
      
      private static const const_1490:String = "text";
      
      private static const const_1489:String = "label";
      
      private static const const_1493:String = "shape";
      ...
      private var var_2696:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1937 = new Dictionary();
         this.var_2698 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1937,this.var_2698);
         this.var_2697 = new Dictionary();
         this.var_2696 = new Dictionary();
         StateCodeTable.fillTables(this.var_2697,this.var_2696);
         this.var_445 = new Dictionary();
         this.var_445[const_1492] = BitmapSkinRenderer;
         this.var_445[const_1488] = BitmapDataRenderer;
         this.var_445[const_1491] = FillSkinRenderer;
         this.var_445[const_1490] = TextSkinRenderer;
         this.var_445[const_1489] = LabelRenderer;
         this.var_445[const_1493] = ShapeSkinRenderer;
         this.var_445[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_445[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_339 == null)
         {
            var_339 = new Array();
            var_339.push(WindowState.const_69);
            var_339.push(WindowState.const_87);
            var_339.push(WindowState.const_100);
            var_339.push(WindowState.const_54);
            var_339.push(WindowState.const_88);
            var_339.push(WindowState.const_89);
            var_339.push(WindowState.const_94);
            var_339.push(WindowState.const_108);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2928 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1937[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1020[param1] == null)
         {
            this.var_1020[param1] = new Array(const_1065);
         }
         this.var_1020[param1][param2] = param3;
         if(this.var_1021[param1] == null)
         {
            this.var_1021[param1] = new Array(const_1065);
         }
         this.var_1021[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1020[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_132)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1021[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_132)
