package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1829:uint = 0;
      
      public static const const_895:uint = 1;
      
      public static const const_1174:uint = 2;
      
      public static const const_811:uint = 4;
      
      public static const const_1665:uint = 8;
      
      public static const const_1784:uint = 16;
      
      public static const const_2014:uint = 64;
      
      public static const const_2034:uint = 128;
      
      public static const const_1175:uint = 256;
      
      protected static var var_581:uint = 0;
      
      protected static var var_338:uint = 0;
       
      
      protected var var_217:DisplayObjectContainer;
      
      protected var var_2159:Boolean;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_217.numChildren > 0)
               {
                  this.var_217.removeChildAt(0);
               }
            }
            this.var_217 = null;
            while(numChildren > 0)
         ...
         if(this.var_875)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_338 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2159,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2159,16777215);
                  }
                  var_338 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_875)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_338 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_217 == null)
         {
            this.var_217 = new Sprite();
            this.var_217.name = this.name + " - Child Container";
            this.var_217.mouseEnabled = false;
            addChild(this.var_217);
         }
         return this.var_217;
      }
      ...
      {
         return this.var_217 != null ? int(this.var_217.numChildren) : 0;
      }
