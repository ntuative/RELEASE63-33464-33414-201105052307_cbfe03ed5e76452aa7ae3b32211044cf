package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_573:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_573[_loc1_]).dispose();
      ...
      {
         var _loc3_:ISkinLayout = this.var_573[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_573[param1.name] = param1;
         return param1;
      }
      
      public function getLayoutByName(param1:String) : ISkinLayout
      {
         return this.var_573[param1];
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_573[param1.name];
         }
         return param1;
      }
