package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_2015:Point;
      
      private var var_1583:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_2015 = new Point();
         this.var_1583 = new Rectangle();
         this.var_327 = new Rectangle();
         this.var_390 = new Dictionary(true);
         this.var_948 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_834 = null;
            for(_loc1_ in this.var_390)
            {
               delete this.var_390[_loc1_];
            }
            this.var_390 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_327.x = param2.x - param1.x;
            this.var_327.y = param2.y - param1.y;
            this.var_327.width = param2.width;
            this.var_327.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_34))
            {
               while(param1.testParamFlag(WindowParam.const_34))
               {
                  ...
                  this.var_327.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_327,WindowRedrawFlag.const_1220);
            if(this.var_834.indexOf(param1) == -1)
            {
      ...
      {
         var _loc2_:WindowRendererItem = this.var_390[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_390[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_948);
            this.var_390[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_823,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_823,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_390[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_390[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_834.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_834.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_327.x = _loc3_.dirty.x;
               this.var_327.y = _loc3_.dirty.y;
               this.var_327.width = _loc3_.dirty.width;
               this.var_327.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_327,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_2015,this.var_1583))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_2015,this.var_1583))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_34))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1583);
