package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_108:String = "default";
      
      public static const const_94:String = "active";
      
      public static const const_89:String = "focused";
      
      public static const const_88:String = "hovering";
      
      public static const const_54:String = "selected";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_403 = SkinLayoutEntity.const_605;
                  break;
               case "move":
                  _loc5_.var_403 = SkinLayoutEntity.const_336;
                  break;
               case "strech":
                  _loc5_.var_403 = SkinLayoutEntity.const_575;
                  break;
               case "tiled":
                  _loc5_.var_403 = SkinLayoutEntity.const_313;
                  break;
               case "center":
                  _loc5_.var_403 = SkinLayoutEntity.const_1096;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_401 = SkinLayoutEntity.const_605;
                  break;
               case "move":
                  _loc5_.var_401 = SkinLayoutEntity.const_336;
                  break;
               case "strech":
                  _loc5_.var_401 = SkinLayoutEntity.const_575;
                  break;
               case "tiled":
                  _loc5_.var_401 = SkinLayoutEntity.const_313;
                  break;
               case "center":
                  _loc5_.var_401 = SkinLayoutEntity.const_1096;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_94:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_108:
               _loc10_ = 0;
               break;
            ...
            case BitmapSkinParser.const_100:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_54:
               _loc10_ = 0;
               break;
