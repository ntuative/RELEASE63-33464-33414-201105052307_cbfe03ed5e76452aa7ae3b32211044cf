package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1712:int = 10000;
      ...
      private var var_1305:IEncryption;
      
      private var var_842:IProtocol;
      
      private var _id:String;
      
      private var var_1304:IMessageClassManager;
      
      private var var_275:ICoreCommunicationManager;
      
      private var var_550:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1304 = new MessageClassManager();
         this.var_77 = new Socket();
         this.var_212 = new Timer(const_1712,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_550)
         {
            this.var_550.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_212.start();
         this.var_841 = getTimer();
      ...
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_275.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_275.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1304.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_550)
         {
            this.var_550.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1305 != null)
         {
            _loc3_ = this.var_1305.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1304.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1305 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_842.getMessages(this.var_551,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_550)
               {
                  this.var_550.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1304.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_275.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_275.getMessageParser(parserClass);
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_551.writeByte(this.var_77.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_212.stop();
         this.var_2035 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_841));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2035 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_841));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_841));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_841));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_841));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_841));
